...
import org.modelica.mdt.debug.gdb.core.model.value.GDBTupleValue;

/**
 * @author Adeel Asghar
 *
 */
public class GDBTupleVariable extends GDBVariable {
	 ...
	 * @param voidPointer
	 */
	public GDBTupleVariable(GDBStackFrame frame, String name,
