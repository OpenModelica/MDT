...
import org.modelica.mdt.debug.gdb.core.model.value.GDBModelicaArrayValue;

/**
 * @author Adeel Asghar
 *
 */
public class GDBModelicaArrayVariable extends GDBVariable {
	 ...
	 * @param voidPointer
	 */
	public GDBModelicaArrayVariable(GDBStackFrame frame, String name,
	...
	public synchronized IValue getValue() throws DebugException {
		...
		if (isRefreshValue()) {
			if (getGDBValue() == null) {
				setGDBValue(new GDBModelicaArrayValue(this));
			} else if (((GDBModelicaArrayValue)getGDBValue()).hasChanged()) {
