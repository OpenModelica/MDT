 ...
 */
package org.openmodelica.modelicaml.editor.xtext.activity.ui.contentassist.antlr;
...
public class ActivitycontrolflowguardexpressionParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.openmodelica.modelicaml.editor.xtext.activity.ui.contentassist.antlr.internal.InternalActivitycontrolflowguardexpressionParser createParser() {
		org.openmodelica.modelicaml.editor.xtext.activity.ui.contentassist.antlr.internal.InternalActivitycontrolflowguardexpressionParser result = new org.openmodelica.modelicaml.editor.xtext.activity.ui.contentassist.antlr.internal.InternalActivitycontrolflowguardexpressionParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getActivityControlFlowExpressionAccess().getGroup(), "rule__ActivityControlFlowExpression__Group__0");
					...
					put(grammarAccess.getActivityControlFlowExpressionAccess().getEpressionAssignment_1(), "rule__ActivityControlFlowExpression__EpressionAssignment_1");
					put(grammarAccess.getExpressionAccess().getExprAssignment_0_1(), "rule__Expression__ExprAssignment_0_1");
					put(grammarAccess.getExpressionAccess().getElseKeywordAssignment_1(), "rule__Expression__ElseKeywordAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.openmodelica.modelicaml.editor.xtext.activity.ui.contentassist.antlr.internal.InternalActivitycontrolflowguardexpressionParser typedParser = (org.openmodelica.modelicaml.editor.xtext.activity.ui.contentassist.antlr.internal.InternalActivitycontrolflowguardexpressionParser) parser;
			typedParser.entryRuleactivityControlFlowExpression();
