...
public class ModelicaMLMainPreferencesPage
	 ...
	 */
	public ModelicaMLMainPreferencesPage() {
		super(GRID);
		setPreferenceStore(Activator.getDefault().getPreferenceStore());
		setDescription("ModelicaML general preferences:");
	}
	...
	public void createFieldEditors() {
		addField(
			new BooleanFieldEditor("useMultipleItemsDialogForCreatingNewElements",
