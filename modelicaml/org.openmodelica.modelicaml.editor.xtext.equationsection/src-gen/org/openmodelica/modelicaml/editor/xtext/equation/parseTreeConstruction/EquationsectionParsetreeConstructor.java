...
* generated by Xtext
*/
package org.openmodelica.modelicaml.editor.xtext.equation.parseTreeConstruction;
...
public class EquationsectionParsetreeConstructor extends AbstractParseTreeConstructor {
...
protected class ThisRootNode extends RootToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 1: return new Equation_Group(this, this, 1, inst);
			case 2: return new When_equation_Group(this, this, 2, inst);
			case 3: return new If_equation_Group(this, this, 3, inst);
			case 4: return new For_equation_Group(this, this, 4, inst);
			case 5: return new Connect_clause_Group(this, this, 5, inst);
			...
			case 16: return new Primary_Alternatives(this, this, 16, inst);
			case 17: return new Name_Function_Group(this, this, 17, inst);
			case 18: return new Initial_ref_Group(this, this, 18, inst);
			case 19: return new ExprDer_Group(this, this, 19, inst);
			case 20: return new Function_call_args_Group(this, this, 20, inst);
			case 21: return new Expression_list_Group(this, this, 21, inst);
			case 22: return new Name_Group(this, this, 22, inst);
			case 23: return new Component_reference_Group(this, this, 23, inst);
			case 24: return new Output_expression_list_Group(this, this, 24, inst);
			case 25: return new Array_subscripts_Group(this, this, 25, inst);
			case 26: return new Subscript_Alternatives(this, this, 26, inst);
			case 27: return new Function_arguments_Alternatives(this, this, 27, inst);
			case 28: return new Fun_Arguments_exp_Group(this, this, 28, inst);
			case 29: return new Fun_Arguments_for_Group(this, this, 29, inst);
			case 30: return new Named_arguments_Group(this, this, 30, inst);
			case 31: return new Named_argument_Group(this, this, 31, inst);
			case 32: return new For_indices_Group(this, this, 32, inst);
			case 33: return new For_index_Group(this, this, 33, inst);
			default: return null;
		}	
	}	
}
...
protected class Equation_section_Group extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Equation_section_Group_1(lastRuleCallOrigin, this, 0, inst);
			case 1: return new Equation_section_Equation_sectionAction_0(lastRuleCallOrigin, this, 1, inst);
			default: return null;
		}	
	}
...
// (Eqn+=equation ";")*
protected class Equation_section_Group_1 extends GroupToken {
	
	public Equation_section_Group_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getEquation_sectionAccess().getGroup_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Equation_section_SemicolonKeyword_1_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// Eqn+=equation
protected class Equation_section_EqnAssignment_1_0 extends AssignmentToken  {
	
	public Equation_section_EqnAssignment_1_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getEquation_sectionAccess().getEqnAssignment_1_0();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getEquationRule().getType().getClassifier())) {
				...
				element = grammarAccess.getEquation_sectionAccess().getEqnEquationParserRuleCall_1_0_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		...
		switch(index) {
			case 0: return new Equation_section_Group_1(lastRuleCallOrigin, next, actIndex, consumed);
			case 1: return new Equation_section_Equation_sectionAction_0(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// ";"
protected class Equation_section_SemicolonKeyword_1_1 extends KeywordToken  {
	
	public Equation_section_SemicolonKeyword_1_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getEquation_sectionAccess().getSemicolonKeyword_1_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Equation_section_EqnAssignment_1_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
protected class Equation_Group extends GroupToken {
	...
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getConnect_clauseRule().getType().getClassifier() && 
		   getEObject().eClass() != grammarAccess.getEquationRule().getType().getClassifier() && 
		   getEObject().eClass() != grammarAccess.getFor_equationRule().getType().getClassifier() && 
		   getEObject().eClass() != grammarAccess.getIf_equationRule().getType().getClassifier() && 
		   getEObject().eClass() != grammarAccess.getWhen_equationRule().getType().getClassifier())
			return null;
		return eObjectConsumer;
	}
...
protected class Equation_Alternatives_0 extends AlternativesToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 1: return new Equation_If_equationParserRuleCall_0_1(lastRuleCallOrigin, this, 1, inst);
			case 2: return new Equation_For_equationParserRuleCall_0_2(lastRuleCallOrigin, this, 2, inst);
			case 3: return new Equation_Connect_clauseParserRuleCall_0_3(lastRuleCallOrigin, this, 3, inst);
			case 4: return new Equation_When_equationParserRuleCall_0_4(lastRuleCallOrigin, this, 4, inst);
			default: return null;
		}	
	}
...
// if_equation
protected class Equation_If_equationParserRuleCall_0_1 extends RuleCallToken {
	
	public Equation_If_equationParserRuleCall_0_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getEquationAccess().getIf_equationParserRuleCall_0_1();
	}
	...
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getIf_equationRule().getType().getClassifier())
			return null;
		if(checkForRecursion(If_equation_Group.class, eObjectConsumer)) return null;
		return eObjectConsumer;
	}
...
// for_equation
protected class Equation_For_equationParserRuleCall_0_2 extends RuleCallToken {
	
	public Equation_For_equationParserRuleCall_0_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getEquationAccess().getFor_equationParserRuleCall_0_2();
	}
	...
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getFor_equationRule().getType().getClassifier())
			return null;
		if(checkForRecursion(For_equation_Group.class, eObjectConsumer)) return null;
		return eObjectConsumer;
	}
...
// connect_clause
protected class Equation_Connect_clauseParserRuleCall_0_3 extends RuleCallToken {
	
	public Equation_Connect_clauseParserRuleCall_0_3(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getEquationAccess().getConnect_clauseParserRuleCall_0_3();
	}
	...
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getConnect_clauseRule().getType().getClassifier())
			return null;
		if(checkForRecursion(Connect_clause_Group.class, eObjectConsumer)) return null;
		return eObjectConsumer;
	}
...
// when_equation
protected class Equation_When_equationParserRuleCall_0_4 extends RuleCallToken {
	
	public Equation_When_equationParserRuleCall_0_4(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getEquationAccess().getWhen_equationParserRuleCall_0_4();
	}
	...
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getWhen_equationRule().getType().getClassifier())
			return null;
		if(checkForRecursion(When_equation_Group.class, eObjectConsumer)) return null;
		return eObjectConsumer;
	}
...
protected class For_equation_For_EqnAssignment_3_0 extends AssignmentToken  {
    ...
    @Override	
	public IEObjectConsumer tryConsume() {
		if((value = eObjectConsumer.getConsumable("For_Eqn",false)) == null) return null;
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new For_equation_Group_3(lastRuleCallOrigin, next, actIndex, consumed);
			case 1: return new For_equation_LoopKeyword_2(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
protected class For_equation_EndKeyword_4 extends KeywordToken  {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 1: return new For_equation_LoopKeyword_2(lastRuleCallOrigin, this, 1, inst);
			default: return null;
		}	
	}
