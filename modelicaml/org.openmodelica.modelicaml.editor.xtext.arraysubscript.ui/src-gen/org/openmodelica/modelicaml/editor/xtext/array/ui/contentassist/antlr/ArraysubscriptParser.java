 ...
 */
package org.openmodelica.modelicaml.editor.xtext.array.ui.contentassist.antlr;
...
public class ArraysubscriptParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.openmodelica.modelicaml.editor.xtext.array.ui.contentassist.antlr.internal.InternalArraysubscriptParser createParser() {
		org.openmodelica.modelicaml.editor.xtext.array.ui.contentassist.antlr.internal.InternalArraysubscriptParser result = new org.openmodelica.modelicaml.editor.xtext.array.ui.contentassist.antlr.internal.InternalArraysubscriptParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getSubscriptAccess().getAlternatives_1(), "rule__Subscript__Alternatives_1");
					...
					put(grammarAccess.getSubscriptAccess().getGroup(), "rule__Subscript__Group__0");
					...
					put(grammarAccess.getSubscriptAccess().getExprAssignment_1_1(), "rule__Subscript__ExprAssignment_1_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.openmodelica.modelicaml.editor.xtext.array.ui.contentassist.antlr.internal.InternalArraysubscriptParser typedParser = (org.openmodelica.modelicaml.editor.xtext.array.ui.contentassist.antlr.internal.InternalArraysubscriptParser) parser;
			typedParser.entryRulesubscript();
