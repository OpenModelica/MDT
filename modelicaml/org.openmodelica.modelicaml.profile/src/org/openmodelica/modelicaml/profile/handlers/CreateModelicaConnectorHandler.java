...
/**
 * The Class CreateModelicaConnectorHandler.
 */
public class CreateModelicaConnectorHandler extends AbstractHandler {
...
private String stereotypePath = Platform.getResourceString(Activator.getDefault().getBundle(), "%p_path_ModelicaClassConstructs");
	...
	/** The stereotyep name. */
	private String stereotypeName = Platform.getResourceString(Activator.getDefault().getBundle(), "%s_connector");
...
//### START: adapt it for a new command handler
		final String commandTitle = "Create New Interface Defintion(s)";
		...
		Command command = new RecordingCommand(editingDomain) {
			...
			protected void doExecute() {
				...
				if (useMultipleItemsDialogForCreatingNewElements) { // with dialog
					...
					String lblText = "Name: ";
					String defaultName = "InterfaceDefinition";
...
private Class createElement(String name){
		...
		if (selectedElement instanceof Class) {
			element = (Class) ((Class)selectedElement).createNestedClassifier(name, UMLPackage.Literals.CLASS);
		}
