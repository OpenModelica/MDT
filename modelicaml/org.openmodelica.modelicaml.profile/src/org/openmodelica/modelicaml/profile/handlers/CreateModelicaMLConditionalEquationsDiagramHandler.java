...
//		if (behavior != null) {
//			Stereotype s = behavior.getApplicableStereotype(Constants.stereotypeQName_ConditionalEquations);
//			if (s != null ) {
//				behavior.applyStereotype(s);
//			}
//			else {
//				Shell shell = PlatformUI.getWorkbench().getActiveWorkbenchWindow().getShell();
//				MessageDialog.openError(shell, "Error:", "Cannot apply ModelicaML stereotype 'ConditionalEquations(Diagram)' to " 
