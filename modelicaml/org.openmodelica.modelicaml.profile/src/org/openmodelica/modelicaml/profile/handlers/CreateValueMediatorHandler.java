 ...
 */
public class CreateValueMediatorHandler extends AbstractHandler {
...
//	private String stereotypeName = Platform.getResourceString(Activator.getDefault().getBundle(), "%s_variable");
	private String stereotypeName = "ValueMediator";
...
private EList<Element> createdElements = new BasicEList<Element>();
	...
	protected Command getCommand(TransactionalEditingDomain editingDomain) {
		final String commandTitle = "Create New ValueM Mediator(s)";
...
//### START: adapt it for a new command handler
				...
				if (selectedElement instanceof Class) {
					...
					if (useMultipleItemsDialogForCreatingNewElements) {
						...
						//**************************************
						element = (Property) ((org.eclipse.uml2.uml.Class)selectedElement).createOwnedAttribute("valueMediator1", null);
