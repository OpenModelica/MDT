...
/**
 * The Class CreateModelicaPortHandler.
 */
public class CreateModelicaPortHandler extends AbstractHandler {
...
private String stereotypePath = Platform.getResourceString(Activator.getDefault().getBundle(), "%p_path_ModelicaCompositeConstructs");
	...
	/** The stereotyep name. */
	private String stereotyepName = Platform.getResourceString(Activator.getDefault().getBundle(), "%s_port");
...
//### START: adapt it for a new command handler
				if (selectedElement instanceof Class) {
					...
					p =(Port) ((org.eclipse.uml2.uml.Class)selectedElement).createOwnedPort(stereotyepName, null);
