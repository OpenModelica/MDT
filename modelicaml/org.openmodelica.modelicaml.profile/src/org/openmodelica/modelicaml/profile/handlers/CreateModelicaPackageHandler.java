...
/**
 * The Class CreateModelicaPackageHandler.
 */
public class CreateModelicaPackageHandler extends AbstractHandler {
...
private String stereotypePath = Platform.getResourceString(Activator.getDefault().getBundle(), "%p_path_ModelicaClassConstructs");
	...
	/** The stereotyep name. */
	private String stereotyepName = Platform.getResourceString(Activator.getDefault().getBundle(), "%s_package");
...
//### START: adapt it for a new command handler
				...
				if (selectedElement instanceof Class) {
					...
					clazz = (Class) ((org.eclipse.uml2.uml.Package)selectedElement).createOwnedClass(stereotyepName, false);
					stereotype = clazz.getApplicableStereotype(stereotypePath+"::"+stereotyepName);
				}
				else {
