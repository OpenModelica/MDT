...
/**
 * The Class CreateModelicaCalculationModelHandler.
 */
public class CreateTestScenarioHandler extends AbstractHandler {
...
//### START: adapt it for a new command handler
	...
	/** The stereotype name. */
	private String stereotypeName = Platform.getResourceString(Activator.getDefault().getBundle(), "%s_calculationModel");
	
	private String stereotypePath2 = Platform.getResourceString(Activator.getDefault().getBundle(), "%p_path_ModelicaMLTestDefinition");
	/** The stereotype name. */
	private String stereotypeName2 = Platform.getResourceString(Activator.getDefault().getBundle(), "%s_testScenario");
...
private Class createElement(String name){
		...
		if (element != null) {
			...
			Stereotype stereotype2 = element.getApplicableStereotype(stereotypePath2+"::"+stereotypeName2);
