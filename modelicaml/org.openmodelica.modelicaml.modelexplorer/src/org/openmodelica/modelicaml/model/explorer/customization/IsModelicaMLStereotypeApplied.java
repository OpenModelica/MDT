...
/**
 * looks for the application of any ModelicaML stereotype based on its qualified
 * name.
 */
public class IsModelicaMLStereotypeApplied implements IJavaModelQuery<NamedElement, Boolean> {
	...
	public Boolean evaluate(final NamedElement context, final ParameterValueList parameterValues)
		...
		EList<Stereotype> list = context.getAppliedStereotypes();
