...
/**
 * returns the name of the generalization target.
 */
public class GetGeneralizationLabel implements IJavaModelQuery<Generalization, String> {
	 ...
	 */
	public String evaluate(final Generalization context, final ParameterValueList parameterValues)
			throws ModelQueryExecutionException {
		EList<Element> list = context.getTargets();
