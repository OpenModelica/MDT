...
public class InitData {
	...
	/**
	 * initial file name e.g. model_init.txt or model_init.xml
	 */
	...
	//TODO [20100912] Die verwendung von ArrayList zur einhaltung der sortierung und gleichzeitig Map zur datenhaltung ist fraglich aber ‰uﬂerst billig...
	...
	public String toString(){
		String s = "InitData -> fileName: " + fileName + " start: " + start + " stop: " + stop + " step: " + step + " tolerance: " + tolerance + " method: " + method + " outputFormat: " + outputFormat;
		return s;
	}
//	/**
