...
public class AbstractClientSyntacticSequencer extends AbstractSyntacticSequencer {

	protected ClientGrammarAccess grammarAccess;
	protected AbstractElementAlias match_component_reference_FullStopKeyword_1_0_q;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (ClientGrammarAccess) access;
		match_component_reference_FullStopKeyword_1_0_q = new TokenAlias(true, false, grammarAccess.getComponent_referenceAccess().getFullStopKeyword_1_0());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if(match_component_reference_FullStopKeyword_1_0_q.equals(syntax))
				emit_component_reference_FullStopKeyword_1_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     '.'?
	 */
	protected void emit_component_reference_FullStopKeyword_1_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
