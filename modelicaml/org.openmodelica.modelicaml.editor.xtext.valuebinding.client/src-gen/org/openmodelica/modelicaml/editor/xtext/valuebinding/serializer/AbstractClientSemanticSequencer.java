...
public class AbstractClientSemanticSequencer extends AbstractSemanticSequencer {

	@Inject
	protected ClientGrammarAccess grammarAccess;
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == ClientPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case ClientPackage.CLIENT_OPERATION:
				if(context == grammarAccess.getClientOperationRule()) {
					sequence_ClientOperation(context, (ClientOperation) semanticObject); 
					return; 
				}
				else break;
	 ...
	 *         SAME left_hand
	 */
	protected void sequence_ClientOperation(EObject context, ClientOperation semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, ClientPackage.Literals.CLIENT_OPERATION__LEFT_HAND) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ClientPackage.Literals.CLIENT_OPERATION__LEFT_HAND));
			if(transientValues.isValueTransient(semanticObject, ClientPackage.Literals.CLIENT_OPERATION__EXPR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ClientPackage.Literals.CLIENT_OPERATION__EXPR));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getClientOperationAccess().getLeft_handLeft_hand_component_referenceParserRuleCall_0_0(), semanticObject.getLeft_hand());
		feeder.accept(grammarAccess.getClientOperationAccess().getExprExpressionParserRuleCall_2_0(), semanticObject.getExpr());
		feeder.finish();
	}
