...
/**
 * The Class IsParameter.
 */
public class IsParameter implements IJavaModelQuery<TypedElement, Boolean> {
	...
	public Boolean evaluate(final TypedElement context, final ParameterValueList parameterValues)
		...
		if (stereotype != null) {
			...
			if (variability != null && ((EnumerationLiteral)variability).getName().equals("parameter")) {
				return true;
			}
		}		
		return false;
