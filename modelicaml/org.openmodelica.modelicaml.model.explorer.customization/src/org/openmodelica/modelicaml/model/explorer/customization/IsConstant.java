...
/**
 * Determines if variable has the prefix 'constant'.
 */
public class IsConstant implements IJavaModelQuery<TypedElement, Boolean> {
	...
	public Boolean evaluate(final TypedElement context, final ParameterValueList parameterValues)
		...
		if (stereotype != null) {
			...
			if (variability != null && ((EnumerationLiteral)variability).getName().equals("constant")) {
				return true;
			}
		}		
		return false;
