...
/**
 * checks if the class has more then x number of properties.
 */
public class IsHaveMoreThanXProperties implements IJavaModelQuery<Classifier, Boolean> {
	...
	public Boolean evaluate(final Classifier context, final ParameterValueList parameterValues)
		...
		if (context.getAllAttributes().size() > 3 ) {
			return false;
		}
		return true;
	}
