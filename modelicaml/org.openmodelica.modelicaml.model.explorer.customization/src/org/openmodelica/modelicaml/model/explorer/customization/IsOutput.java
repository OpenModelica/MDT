...
/**
 * determines if variable has the prefix 'output'.
 */
public class IsOutput implements IJavaModelQuery<TypedElement, Boolean> {
	...
	public Boolean evaluate(final TypedElement context, final ParameterValueList parameterValues)
		...
		if (stereotype != null) {
			...
			if (causality != null && ((EnumerationLiteral)causality).getName().equals("output")) {
				return true;
			}
		}
		return false;
