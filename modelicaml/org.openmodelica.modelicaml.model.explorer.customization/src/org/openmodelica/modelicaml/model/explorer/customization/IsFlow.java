...
/**
 * determines if the variable has the prefix flow.
 */
public class IsFlow implements IJavaModelQuery<TypedElement, Boolean> {
	...
	public Boolean evaluate(final TypedElement context, final ParameterValueList parameterValues)
		...
		if (stereotype != null) {
			...
			if (causality != null && ((EnumerationLiteral)causality).getName().equals("flow")) {
				return true;
			}
		}
		return false;
