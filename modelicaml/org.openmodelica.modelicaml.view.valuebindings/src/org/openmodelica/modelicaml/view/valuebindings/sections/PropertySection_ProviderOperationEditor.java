...
//				valueClient = selectedUmlElement;
	...
	private Boolean isValidElement(){
		...
		if ( this.selectedUmlElement instanceof Property && 
				((Property)this.selectedUmlElement).getAppliedStereotype(Constants.stereotypeQName_ValueProvider) != null 
			) {
			return true;
		}
		// ################################ Adjust end
...
//			valueClient = null; // reset the element. important when another element is selected.
...
//				ModelicaMLContentAssist.replaceFirstComponentName("getOwnPath");
//				ModelicaMLContentAssist.replaceFirstComponentName("ownPath");
			}
...
//		if (selectedUmlElement.getAppliedStereotype(Constants.stereotypeQName_ValueProvider) != null) {
//			return true;
//		}
//		return false;
//	}
	...
	private void storeText(final EObject element, final String bodyText) {
		CompoundCommand cc = new CompoundCommand("Update Value Provider operation code");
		
		// get the stereotype
		Stereotype stereotype_temp = selectedUmlElement.getAppliedStereotype(Constants.stereotypeQName_ValueProvider);
...
//				}
	...
	private void generateUMLModelMarker(){
		...
		String message = "The " + ((NamedElement)selectedUmlElement).eClass().getName() 
							+ " '" + ((NamedElement)selectedUmlElement).getName() + "' has errors in its Value Provider Operation code.";
