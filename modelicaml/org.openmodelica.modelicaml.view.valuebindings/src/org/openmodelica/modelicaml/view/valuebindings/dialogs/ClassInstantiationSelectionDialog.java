...
public class ClassInstantiationSelectionDialog extends Dialog {
	...
	// Constants 
	protected static final Image errorIcon = SWTResourceManager.getImage(ClassInstantiationSelectionDialog.class, "/org/eclipse/jface/dialogs/images/message_error.gif");
	protected static final Image elementIcon = SWTResourceManager.getImage(ClassInstantiationSelectionDialog.class, "/icons/Class.gif");
	protected static final Image selectIcon = SWTResourceManager.getImage(ClassInstantiationSelectionDialog.class, "/icons/selectItem.gif");
	...
	private Action actionToRunAfterOK;
	
	public ClassInstantiationSelectionDialog(	Shell parent, 
									Image image,
									String title, 
									String message, 
									ClassInstantiation preSelectedElement,
									Action actionToRunAfterOK
									) {
		super(parent);

		this.actionToRunAfterOK = actionToRunAfterOK;
		...
		if (preSelectedElement instanceof ClassInstantiation) {
			this.selectedElement = preSelectedElement.getSelectedClass();
		}
	...
	protected ISelectionListener selectionListener = new ISelectionListener() {
	        ...
	        if (sourcepart != ClassInstantiationSelectionDialog.this && selection instanceof IStructuredSelection) {
...
//					}
	...
	private boolean isValidDesignModel(NamedElement element){
		...
		if (element.getAppliedStereotype(Constants.stereotypeQName_Simulation) != null) { return false; }
		...
		bttOK.addMouseListener(new org.eclipse.swt.events.MouseAdapter() {
			...
			public void mouseDown(org.eclipse.swt.events.MouseEvent e) {
				...
				if (selectedElement instanceof NamedElement) {
					...
					/*
					 * Run the reload action of the viewer so that the view can get back the 
					 * selected object
					 */
					if (actionToRunAfterOK != null) {
						actionToRunAfterOK.run();
					}
