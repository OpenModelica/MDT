...
package org.openmodelica.modelicaml.editor.xtext.declaration.services;
...
@Singleton
public class DeclarationGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class Component_declarationElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cModModificationParserRuleCall_0_0 = (RuleCall)cModAssignment_0.eContents().get(0);
		...
		//modification
		public RuleCall getModModificationParserRuleCall_0_0() { return cModModificationParserRuleCall_0_0; }
	...
	@Inject
	public DeclarationGrammarAccess(GrammarProvider grammarProvider,
