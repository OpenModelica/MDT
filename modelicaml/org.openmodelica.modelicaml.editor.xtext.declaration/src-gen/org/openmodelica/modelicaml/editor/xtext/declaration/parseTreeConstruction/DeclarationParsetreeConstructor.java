...
* generated by Xtext
*/
package org.openmodelica.modelicaml.editor.xtext.declaration.parseTreeConstruction;
...
public class DeclarationParsetreeConstructor extends AbstractParseTreeConstructor {
...
protected class ThisRootNode extends RootToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 1: return new Modification_Alternatives(this, this, 1, inst);
			case 2: return new Conditional_attribute_Group(this, this, 2, inst);
			...
			case 20: return new Component_reference_Group(this, this, 20, inst);
			case 21: return new Output_expression_list_Group(this, this, 21, inst);
			case 22: return new Array_subscripts_Group(this, this, 22, inst);
			case 23: return new Subscript_Alternatives(this, this, 23, inst);
			case 24: return new Function_arguments_Alternatives(this, this, 24, inst);
			case 25: return new Fun_Arguments_exp_Group(this, this, 25, inst);
			case 26: return new Fun_Arguments_for_Group(this, this, 26, inst);
			case 27: return new Named_arguments_Group(this, this, 27, inst);
			case 28: return new Named_argument_Group(this, this, 28, inst);
			case 29: return new For_indices_Group(this, this, 29, inst);
			case 30: return new For_index_Group(this, this, 30, inst);
			default: return null;
		}	
	}	
}
...
// Mod=modification
protected class Component_declaration_ModAssignment_0 extends AssignmentToken  {
	
	public Component_declaration_ModAssignment_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getComponent_declarationAccess().getModAssignment_0();
	}
    ...
    @Override	
	public IEObjectConsumer tryConsume() {
		if((value = eObjectConsumer.getConsumable("Mod",true)) == null) return null;
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getModificationRule().getType().getClassifier())) {
				...
				element = grammarAccess.getComponent_declarationAccess().getModModificationParserRuleCall_0_0(); 
				consumed = obj;
				return param;
			}
		}
...
protected class Component_declaration_Conditional_AttAssignment_1 extends AssignmentToken  {
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new Component_declaration_ModAssignment_0(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
protected class Component_declaration_CommentParserRuleCall_2 extends UnassignedTextToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 1: return new Component_declaration_ModAssignment_0(lastRuleCallOrigin, this, 1, inst);
			default: return null;
		}	
	}
...
protected class Modification_Group_0 extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Modification_ExprAssignment_0_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// "="
protected class Modification_EqualsSignKeyword_0_0 extends KeywordToken  {
	
	public Modification_EqualsSignKeyword_0_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getModificationAccess().getEqualsSignKeyword_0_0();
	}
...
// Expr=expression
protected class Modification_ExprAssignment_0_1 extends AssignmentToken  {
	
	public Modification_ExprAssignment_0_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getModificationAccess().getExprAssignment_0_1();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getExpressionRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getModificationAccess().getExprExpressionParserRuleCall_0_1_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new Modification_EqualsSignKeyword_0_0(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// ":="
protected class Modification_ColonEqualsSignKeyword_1_0 extends KeywordToken  {
	
	public Modification_ColonEqualsSignKeyword_1_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getModificationAccess().getColonEqualsSignKeyword_1_0();
	}
...
protected class Modification_ExprAssignment_1_1 extends AssignmentToken  {
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new Modification_ColonEqualsSignKeyword_1_0(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
