...
public class AbstractDeclarationSemanticSequencer extends AbstractSemanticSequencer {

	@Inject
	protected DeclarationGrammarAccess grammarAccess;
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == DeclarationPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
	...
	/**
	 * Constraint:
	 *     (Mod=modification Conditional_Att=conditional_attribute?)?
	 *
	 * Features:
	 *    Mod[0, 1]
	 *         MANDATORY_IF_SET Conditional_Att
	 *    Conditional_Att[0, 1]
	 *         EXCLUDE_IF_UNSET Mod
	 */
	...
	protected void sequence_conditional_attribute(EObject context, conditional_attribute semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, DeclarationPackage.Literals.CONDITIONAL_ATTRIBUTE__EXPR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DeclarationPackage.Literals.CONDITIONAL_ATTRIBUTE__EXPR));
		}
