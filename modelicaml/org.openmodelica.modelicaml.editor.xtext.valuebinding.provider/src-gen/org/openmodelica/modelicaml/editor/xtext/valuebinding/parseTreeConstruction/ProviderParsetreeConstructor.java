...
public class ProviderParsetreeConstructor extends AbstractParseTreeConstructor {
...
protected class ThisRootNode extends RootToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ProviderOperation_ExprAssignment(this, this, 0, inst);
			case 1: return new Name_Group(this, this, 1, inst);
			case 2: return new Component_reference_Group(this, this, 2, inst);
...
// Expr=expression?
protected class ProviderOperation_ExprAssignment extends AssignmentToken  {
	
	public ProviderOperation_ExprAssignment(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getProviderOperationAccess().getExprAssignment();
	}
	...
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getProviderOperationRule().getType().getClassifier())
			return null;
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getExpressionRule().getType().getClassifier())) {
				...
				element = grammarAccess.getProviderOperationAccess().getExprExpressionParserRuleCall_0(); 
				consumed = obj;
				return param;
			}
		}
