...
// Entry rule entryRuleProviderOperation
entryRuleProviderOperation returns [EObject current=null] 
	:
	{ currentNode = createCompositeNode(grammarAccess.getProviderOperationRule(), currentNode); }
	 ...
	 { $current=$iv_ruleProviderOperation.current; } 
	 EOF 
;

// Rule ProviderOperation
ruleProviderOperation returns [EObject current=null] 
