...
//		layout.addPerspectiveShortcut("org.eclipse.jdt.ui.JavaPerspective");
		...
		// hide action sets
		PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().hideActionSet("org.eclipse.amalgam.discovery.modeling.toolbars.discoveryCommand");
		PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().hideActionSet("org.eclipse.papyrus.infra.discovery.ui.menu.toolbars.discoveryCommand");
		PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().hideActionSet("org.eclipse.emf.facet.common.editor.actionSet");		
		...
		PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().hideActionSet("org.eclipse.papyrus.infra.core.commands.dropdowncommand");
		PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().hideActionSet("org.eclipse.amalgam.discovery.modeling.toolbars.discoveryCommand");		
		PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().hideActionSet("org.eclipse.ui.edit.text.gotoLastEditPosition");
	}
