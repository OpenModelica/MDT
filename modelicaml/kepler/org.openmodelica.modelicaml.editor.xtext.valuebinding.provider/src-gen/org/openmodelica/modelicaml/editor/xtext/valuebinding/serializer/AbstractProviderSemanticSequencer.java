...
public class AbstractProviderSemanticSequencer extends AbstractSemanticSequencer {

	@Inject
	protected ProviderGrammarAccess grammarAccess;
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == ModeleditorPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case ProviderPackage.PROVIDER_OPERATION:
				if(context == grammarAccess.getProviderOperationRule()) {
					sequence_ProviderOperation(context, (ProviderOperation) semanticObject); 
					return; 
				}
				else break;
	 ...
	 *    Expr[0, 1]
	 */
	protected void sequence_ProviderOperation(EObject context, ProviderOperation semanticObject) {
