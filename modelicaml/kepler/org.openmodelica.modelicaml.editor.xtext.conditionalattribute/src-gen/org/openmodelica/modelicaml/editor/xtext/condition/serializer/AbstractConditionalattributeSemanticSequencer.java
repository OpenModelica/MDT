 ...
 */
package org.openmodelica.modelicaml.editor.xtext.condition.serializer;
...
public class AbstractConditionalattributeSemanticSequencer extends AbstractSemanticSequencer {

	@Inject
	protected ConditionalattributeGrammarAccess grammarAccess;
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == ConditionalattributePackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case ConditionalattributePackage.CONDITIONAL_ATTRIBUTE:
