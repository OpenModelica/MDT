 ...
 */
package org.openmodelica.modelicaml.generate.modelica.uml2modelica.services;
...
public class UmlServices {
	 ...
	 */
	//*****************************************************************
	//REWRITE THIS METHOD ***********WARNING********
	
	/*public ArrayList<Element> filterStereotype(EList<Element> eltList,
...
//		}
	...
	*/
	public ArrayList<Element> filterStereotype(ArrayList<Element> eltList
			) { // throws ENodeCastException
