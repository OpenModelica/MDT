 ...
 * <ul>
 *   <li>{@link org.openmodelica.modelicaml.editor.xtext.modification.modification.if_equation#getExprtrue <em>Exprtrue</em>}</li>
 *   <li>{@link org.openmodelica.modelicaml.editor.xtext.modification.modification.if_equation#getEqn <em>Eqn</em>}</li>
 *   <li>{@link org.openmodelica.modelicaml.editor.xtext.modification.modification.if_equation#getExprStilltrue <em>Expr Stilltrue</em>}</li>
 *   <li>{@link org.openmodelica.modelicaml.editor.xtext.modification.modification.if_equation#getThenEqn <em>Then Eqn</em>}</li>
 *   <li>{@link org.openmodelica.modelicaml.editor.xtext.modification.modification.if_equation#getElseEqn <em>Else Eqn</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.openmodelica.modelicaml.editor.xtext.modification.modification.ModificationPackage#getif_equation()
 * @model
 * @generated
 */
public interface if_equation extends EObject
{
  /**
   ...
   * @see org.openmodelica.modelicaml.editor.xtext.modification.modification.ModificationPackage#getif_equation_Exprtrue()
  ...
  /**
   * Sets the value of the '{@link org.openmodelica.modelicaml.editor.xtext.modification.modification.if_equation#getExprtrue <em>Exprtrue</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.openmodelica.modelicaml.editor.xtext.modification.modification.ModificationPackage#getif_equation_Eqn()
   * @model containment="true"
   * @generated
   */
   ...
   * @see org.openmodelica.modelicaml.editor.xtext.modification.modification.ModificationPackage#getif_equation_ExprStilltrue()
   * @model containment="true"
   * @generated
   */
   ...
   * @see org.openmodelica.modelicaml.editor.xtext.modification.modification.ModificationPackage#getif_equation_ThenEqn()
   * @model containment="true"
   * @generated
   */
   ...
   * @see org.openmodelica.modelicaml.editor.xtext.modification.modification.ModificationPackage#getif_equation_ElseEqn()
   * @model containment="true"
   * @generated
   */
