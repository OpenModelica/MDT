 ...
 * @generated
 */
public class ActivitycontrolflowguardexpressionSwitch<T> extends Switch<T>
{
  /**
   ...
   * @generated
   */
  public ActivitycontrolflowguardexpressionSwitch()
  {
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        activityControlFlowExpression activityControlFlowExpression = (activityControlFlowExpression)theEObject;
        T result = caseactivityControlFlowExpression(activityControlFlowExpression);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>activity Control Flow Expression</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>activity Control Flow Expression</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseactivityControlFlowExpression(activityControlFlowExpression object)
  {
    return null;
  }
...
} //ActivitycontrolflowguardexpressionSwitch
