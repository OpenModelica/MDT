...
package org.openmodelica.modelicaml.editor.xtext.activity.services;
...
@Singleton
public class ActivitycontrolflowguardexpressionGrammarAccess extends AbstractGrammarElementFinder {
	
	
	public class ActivityControlFlowExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "activityControlFlowExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cActivityControlFlowExpressionAction_0 = (Action)cGroup.eContents().get(0);
		private final Assignment cEpressionAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cEpressionExpressionParserRuleCall_1_0 = (RuleCall)cEpressionAssignment_1.eContents().get(0);
		
		//activityControlFlowExpression:
		//	{activityControlFlowExpression} Epression=expression?;
		...
		//{activityControlFlowExpression}
		public Action getActivityControlFlowExpressionAction_0() { return cActivityControlFlowExpressionAction_0; }

		//Epression=expression?
		public Assignment getEpressionAssignment_1() { return cEpressionAssignment_1; }

		//expression
		public RuleCall getEpressionExpressionParserRuleCall_1_0() { return cEpressionExpressionParserRuleCall_1_0; }
	}
	...
	public class ExpressionElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cExprSimple_expressionParserRuleCall_0_1_0 = (RuleCall)cExprAssignment_0_1.eContents().get(0);
		private final Assignment cElseKeywordAssignment_1 = (Assignment)cAlternatives.eContents().get(1);
		private final Keyword cElseKeywordElseKeyword_1_0 = (Keyword)cElseKeywordAssignment_1.eContents().get(0);
		
		////expression:
		////simple_Exp=simple_expression     //not using if expression then expression { elseif expression then expression }else expression
		////; expression: // Just need logical expressions without if else statements
		//	{expression} Expr= //not using if expression then expression { elseif expression then expression }else expression
		//	simple_expression | ElseKeyword="else";
		public ParserRule getRule() { return rule; }
		...
		//Expr= //not using if expression then expression { elseif expression then expression }else expression
		//simple_expression
		public Assignment getExprAssignment_0_1() { return cExprAssignment_0_1; }

		////not using if expression then expression { elseif expression then expression }else expression
		//simple_expression
		public RuleCall getExprSimple_expressionParserRuleCall_0_1_0() { return cExprSimple_expressionParserRuleCall_0_1_0; }

		//ElseKeyword="else"
		public Assignment getElseKeywordAssignment_1() { return cElseKeywordAssignment_1; }

		//"else"
		public Keyword getElseKeywordElseKeyword_1_0() { return cElseKeywordElseKeyword_1_0; }
	}
	
	
	private ActivityControlFlowExpressionElements pActivityControlFlowExpression;
	...
	@Inject
	public ActivitycontrolflowguardexpressionGrammarAccess(GrammarProvider grammarProvider,
	...
	//activityControlFlowExpression:
	//	{activityControlFlowExpression} Epression=expression?;
	public ActivityControlFlowExpressionElements getActivityControlFlowExpressionAccess() {
		return (pActivityControlFlowExpression != null) ? pActivityControlFlowExpression : (pActivityControlFlowExpression = new ActivityControlFlowExpressionElements());
	}
	
	public ParserRule getActivityControlFlowExpressionRule() {
		return getActivityControlFlowExpressionAccess().getRule();
	}
