...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Algorithm Macros GEN INC</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.openmodelica.modelicaml.editor.xtext.algorithm.algorithmsection.impl.Algorithm_Macros_GEN_INCImpl#getComponent_reference <em>Component reference</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class Algorithm_Macros_GEN_INCImpl extends MinimalEObjectImpl.Container implements Algorithm_Macros_GEN_INC
{
  /**
   ...
   * @generated
   */
  protected Algorithm_Macros_GEN_INCImpl()
  {
    super();
  }
  ...
  {
    return AlgorithmsectionPackage.Literals.ALGORITHM_MACROS_GEN_INC;
  }
  ...
  public NotificationChain basicSetComponent_reference(component_reference newComponent_reference, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlgorithmsectionPackage.ALGORITHM_MACROS_GEN_INC__COMPONENT_REFERENCE, oldComponent_reference, newComponent_reference);
  ...
  public void setComponent_reference(component_reference newComponent_reference)
  {
    if (newComponent_reference != component_reference)
    {
      ...
      if (component_reference != null)
        msgs = ((InternalEObject)component_reference).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlgorithmsectionPackage.ALGORITHM_MACROS_GEN_INC__COMPONENT_REFERENCE, null, msgs);
      if (newComponent_reference != null)
        msgs = ((InternalEObject)newComponent_reference).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlgorithmsectionPackage.ALGORITHM_MACROS_GEN_INC__COMPONENT_REFERENCE, null, msgs);
      msgs = basicSetComponent_reference(newComponent_reference, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlgorithmsectionPackage.ALGORITHM_MACROS_GEN_INC__COMPONENT_REFERENCE, newComponent_reference, newComponent_reference));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AlgorithmsectionPackage.ALGORITHM_MACROS_GEN_INC__COMPONENT_REFERENCE:
