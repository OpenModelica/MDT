...
entryRuleAlgorithm_Macros_GEN_SIGNAL returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getAlgorithm_Macros_GEN_SIGNALRule()); }
	 ...
	 { $current=$iv_ruleAlgorithm_Macros_GEN_SIGNAL.current; } 
	 EOF 
;

// Rule Algorithm_Macros_GEN_SIGNAL
ruleAlgorithm_Macros_GEN_SIGNAL returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='GEN_SIGNAL' 
    {
...
entryRuleAlgorithm_Macros_GEN_INC returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getAlgorithm_Macros_GEN_INCRule()); }
	 ...
	 { $current=$iv_ruleAlgorithm_Macros_GEN_INC.current; } 
	 EOF 
;

// Rule Algorithm_Macros_GEN_INC
ruleAlgorithm_Macros_GEN_INC returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='GEN_INC' 
...
entryRuleAlgorithm_Macros_GEN_CHANGE returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getAlgorithm_Macros_GEN_CHANGERule()); }
	 ...
	 { $current=$iv_ruleAlgorithm_Macros_GEN_CHANGE.current; } 
	 EOF 
;

// Rule Algorithm_Macros_GEN_CHANGE
ruleAlgorithm_Macros_GEN_CHANGE returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='GEN_CHANGE' 
    {
