...
/**
 * Determines if variable has the prefix 'stream'.
 */
public class IsStream implements IJavaModelQuery<TypedElement, Boolean> {
	...
	public Boolean evaluate(final TypedElement context, final ParameterValueList parameterValues)
		...
		if (stereotype != null) {
			Object causality = context.getValue(stereotype, "flowFlag");
			if (causality != null && ((EnumerationLiteral)causality).getName().equals("stream")) {
				return true;
			}
		}
		return false;
