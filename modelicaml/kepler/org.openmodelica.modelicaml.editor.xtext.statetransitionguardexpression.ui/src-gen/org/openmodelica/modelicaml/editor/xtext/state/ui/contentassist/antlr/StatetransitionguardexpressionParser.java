...
public class StatetransitionguardexpressionParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.openmodelica.modelicaml.editor.xtext.state.ui.contentassist.antlr.internal.InternalStatetransitionguardexpressionParser createParser() {
		org.openmodelica.modelicaml.editor.xtext.state.ui.contentassist.antlr.internal.InternalStatetransitionguardexpressionParser result = new org.openmodelica.modelicaml.editor.xtext.state.ui.contentassist.antlr.internal.InternalStatetransitionguardexpressionParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMacro_AfterAccess().getAlternatives_2(), "rule__Macro_After__Alternatives_2");
					put(grammarAccess.getMacro_BEFOREAccess().getAlternatives_2(), "rule__Macro_BEFORE__Alternatives_2");
					...
					put(grammarAccess.getPrimaryAccess().getGroup_12(), "rule__Primary__Group_12__0");
					put(grammarAccess.getPrimaryAccess().getGroup_13(), "rule__Primary__Group_13__0");
					put(grammarAccess.getPrimaryAccess().getGroup_13_2(), "rule__Primary__Group_13_2__0");
					put(grammarAccess.getPrimaryAccess().getGroup_14(), "rule__Primary__Group_14__0");
					put(grammarAccess.getMacro_AfterAccess().getGroup(), "rule__Macro_After__Group__0");
					put(grammarAccess.getMacro_BEFOREAccess().getGroup(), "rule__Macro_BEFORE__Group__0");
					put(grammarAccess.getMacro_SIGNALAccess().getGroup(), "rule__Macro_SIGNAL__Group__0");
					put(grammarAccess.getMacro_EVENTAccess().getGroup(), "rule__Macro_EVENT__Group__0");
					put(grammarAccess.getMacro_CHANGEAccess().getGroup(), "rule__Macro_CHANGE__Group__0");
					...
					put(grammarAccess.getExpressionAccess().getSimple_ExprAssignment_1(), "rule__Expression__Simple_ExprAssignment_1");
					...
					put(grammarAccess.getPrimaryAccess().getMac_AAssignment_7(), "rule__Primary__Mac_AAssignment_7");
					put(grammarAccess.getPrimaryAccess().getMac_EAssignment_8(), "rule__Primary__Mac_EAssignment_8");
					put(grammarAccess.getPrimaryAccess().getMac_CAssignment_9(), "rule__Primary__Mac_CAssignment_9");
					put(grammarAccess.getPrimaryAccess().getMac_SAssignment_10(), "rule__Primary__Mac_SAssignment_10");
					put(grammarAccess.getPrimaryAccess().getComponent_referenceAssignment_11(), "rule__Primary__Component_referenceAssignment_11");
					put(grammarAccess.getPrimaryAccess().getOutput_expr_listAssignment_12_1(), "rule__Primary__Output_expr_listAssignment_12_1");
					put(grammarAccess.getPrimaryAccess().getExpre_listAssignment_13_1(), "rule__Primary__Expre_listAssignment_13_1");
					...
					put(grammarAccess.getMacro_BEFOREAccess().getIntAssignment_2_0(), "rule__Macro_BEFORE__IntAssignment_2_0");
					put(grammarAccess.getMacro_BEFOREAccess().getNumAssignment_2_1(), "rule__Macro_BEFORE__NumAssignment_2_1");
					put(grammarAccess.getMacro_BEFOREAccess().getComponent_referenceAssignment_2_2(), "rule__Macro_BEFORE__Component_referenceAssignment_2_2");
					put(grammarAccess.getMacro_SIGNALAccess().getComponent_referenceAssignment_2(), "rule__Macro_SIGNAL__Component_referenceAssignment_2");
					put(grammarAccess.getMacro_EVENTAccess().getComponent_referenceAssignment_2(), "rule__Macro_EVENT__Component_referenceAssignment_2");
					put(grammarAccess.getMacro_CHANGEAccess().getComponent_referenceAssignment_2(), "rule__Macro_CHANGE__Component_referenceAssignment_2");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.openmodelica.modelicaml.editor.xtext.state.ui.contentassist.antlr.internal.InternalStatetransitionguardexpressionParser typedParser = (org.openmodelica.modelicaml.editor.xtext.state.ui.contentassist.antlr.internal.InternalStatetransitionguardexpressionParser) parser;
			typedParser.entryRuleguardExpression();
