...
/**
 * The Class ArraySubscriptsSection.
 */
public class ArraySubscriptsSection extends AbstractMultiStringSection {

	/**
	 * Instantiates a new array subscripts section.
	 */
	public ArraySubscriptsSection() {
		super();
		stereotypPropertieName = "arraySize"; 
	}
