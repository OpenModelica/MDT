 ...
 */
package org.openmodelica.modelicaml.editor.xtext.declaration.ui.contentassist.antlr;
...
public class DeclarationParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.openmodelica.modelicaml.editor.xtext.declaration.ui.contentassist.antlr.internal.InternalDeclarationParser createParser() {
		org.openmodelica.modelicaml.editor.xtext.declaration.ui.contentassist.antlr.internal.InternalDeclarationParser result = new org.openmodelica.modelicaml.editor.xtext.declaration.ui.contentassist.antlr.internal.InternalDeclarationParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getComponent_declarationAccess().getModAssignment_0(), "rule__Component_declaration__ModAssignment_0");
					...
					put(grammarAccess.getModificationAccess().getExprAssignment_0_1(), "rule__Modification__ExprAssignment_0_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.openmodelica.modelicaml.editor.xtext.declaration.ui.contentassist.antlr.internal.InternalDeclarationParser typedParser = (org.openmodelica.modelicaml.editor.xtext.declaration.ui.contentassist.antlr.internal.InternalDeclarationParser) parser;
			typedParser.entryRulecomponent_declaration();
