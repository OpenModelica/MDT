...
public class StatetransitionguardexpressionParsetreeConstructor extends AbstractParseTreeConstructor {
...
protected class ThisRootNode extends RootToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Expression_Simple_ExprAssignment(this, this, 0, inst);
			case 1: return new Primary_Alternatives(this, this, 1, inst);
			case 2: return new Macro_After_Group(this, this, 2, inst);
			case 3: return new Macro_BEFORE_Group(this, this, 3, inst);
			case 4: return new Macro_SIGNAL_Group(this, this, 4, inst);
			case 5: return new Macro_EVENT_Group(this, this, 5, inst);
			case 6: return new Macro_CHANGE_Group(this, this, 6, inst);
			case 7: return new Simple_expression_Group(this, this, 7, inst);
			case 8: return new Conditional_expr_Group(this, this, 8, inst);
			case 9: return new Logical_expression_Group(this, this, 9, inst);
			case 10: return new Logical_term_Group(this, this, 10, inst);
			case 11: return new Logical_factor_Group(this, this, 11, inst);
			case 12: return new Relation_Group(this, this, 12, inst);
			case 13: return new Arithmetic_expression_Group(this, this, 13, inst);
			case 14: return new Term_Group(this, this, 14, inst);
			case 15: return new Factor_Group(this, this, 15, inst);
			case 16: return new Name_Function_Group(this, this, 16, inst);
			case 17: return new Initial_ref_Group(this, this, 17, inst);
			case 18: return new ExprDer_Group(this, this, 18, inst);
			case 19: return new Function_call_args_Group(this, this, 19, inst);
			case 20: return new Expression_list_Group(this, this, 20, inst);
			case 21: return new Name_Group(this, this, 21, inst);
			case 22: return new Component_reference_Group(this, this, 22, inst);
			case 23: return new Output_expression_list_Group(this, this, 23, inst);
			case 24: return new Array_subscripts_Group(this, this, 24, inst);
			case 25: return new Subscript_Alternatives(this, this, 25, inst);
			case 26: return new Function_arguments_Alternatives(this, this, 26, inst);
			case 27: return new Fun_Arguments_exp_Group(this, this, 27, inst);
			case 28: return new Fun_Arguments_for_Group(this, this, 28, inst);
			case 29: return new Named_arguments_Group(this, this, 29, inst);
			case 30: return new Named_argument_Group(this, this, 30, inst);
			case 31: return new For_indices_Group(this, this, 31, inst);
			case 32: return new For_index_Group(this, this, 32, inst);
			default: return null;
		}	
	}	
}
...
// simple_Expr=simple_expression?
protected class Expression_Simple_ExprAssignment extends AssignmentToken  {
	
	public Expression_Simple_ExprAssignment(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getExpressionAccess().getSimple_ExprAssignment();
	}
	...
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getExpressionRule().getType().getClassifier())
			return null;
		if((value = eObjectConsumer.getConsumable("simple_Expr",false)) == null) return null;
		IEObjectConsumer obj = eObjectConsumer.cloneAndConsume("simple_Expr");
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			IEObjectConsumer param = createEObjectConsumer((EObject)value);
			if(param.isInstanceOf(grammarAccess.getSimple_expressionRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getExpressionAccess().getSimple_ExprSimple_expressionParserRuleCall_0(); 
				consumed = obj;
				return param;
			}
		}
...
protected class Primary_Alternatives extends AlternativesToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 7: return new Primary_Mac_AAssignment_7(lastRuleCallOrigin, this, 7, inst);
			case 8: return new Primary_Mac_EAssignment_8(lastRuleCallOrigin, this, 8, inst);
			case 9: return new Primary_Mac_CAssignment_9(lastRuleCallOrigin, this, 9, inst);
			case 10: return new Primary_Mac_SAssignment_10(lastRuleCallOrigin, this, 10, inst);
			case 11: return new Primary_Component_referenceAssignment_11(lastRuleCallOrigin, this, 11, inst);
			case 12: return new Primary_Group_12(lastRuleCallOrigin, this, 12, inst);
...
// Mac_A=Macro_After
protected class Primary_Mac_AAssignment_7 extends AssignmentToken  {
	
	public Primary_Mac_AAssignment_7(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getPrimaryAccess().getMac_AAssignment_7();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_After_Group(this, this, 0, inst);
			default: return null;
		}	
	}
    ...
    @Override	
	public IEObjectConsumer tryConsume() {
		if((value = eObjectConsumer.getConsumable("Mac_A",true)) == null) return null;
		IEObjectConsumer obj = eObjectConsumer.cloneAndConsume("Mac_A");
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			IEObjectConsumer param = createEObjectConsumer((EObject)value);
			if(param.isInstanceOf(grammarAccess.getMacro_AfterRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getPrimaryAccess().getMac_AMacro_AfterParserRuleCall_7_0(); 
				consumed = obj;
				return param;
			}
		}
...
// Mac_E=Macro_EVENT
protected class Primary_Mac_EAssignment_8 extends AssignmentToken  {
	
	public Primary_Mac_EAssignment_8(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getPrimaryAccess().getMac_EAssignment_8();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_EVENT_Group(this, this, 0, inst);
			default: return null;
		}	
	}
    ...
    @Override	
	public IEObjectConsumer tryConsume() {
		if((value = eObjectConsumer.getConsumable("Mac_E",true)) == null) return null;
		IEObjectConsumer obj = eObjectConsumer.cloneAndConsume("Mac_E");
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			IEObjectConsumer param = createEObjectConsumer((EObject)value);
			if(param.isInstanceOf(grammarAccess.getMacro_EVENTRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getPrimaryAccess().getMac_EMacro_EVENTParserRuleCall_8_0(); 
				consumed = obj;
				return param;
			}
		}
...
// Mac_C=Macro_CHANGE
protected class Primary_Mac_CAssignment_9 extends AssignmentToken  {
	
	public Primary_Mac_CAssignment_9(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getPrimaryAccess().getMac_CAssignment_9();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_CHANGE_Group(this, this, 0, inst);
			default: return null;
		}	
	}
    ...
    @Override	
	public IEObjectConsumer tryConsume() {
		if((value = eObjectConsumer.getConsumable("Mac_C",true)) == null) return null;
		IEObjectConsumer obj = eObjectConsumer.cloneAndConsume("Mac_C");
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			IEObjectConsumer param = createEObjectConsumer((EObject)value);
			if(param.isInstanceOf(grammarAccess.getMacro_CHANGERule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getPrimaryAccess().getMac_CMacro_CHANGEParserRuleCall_9_0(); 
				consumed = obj;
				return param;
			}
		}
...
// Mac_S=Macro_SIGNAL
protected class Primary_Mac_SAssignment_10 extends AssignmentToken  {
	
	public Primary_Mac_SAssignment_10(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getPrimaryAccess().getMac_SAssignment_10();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_SIGNAL_Group(this, this, 0, inst);
			default: return null;
		}	
	}
    ...
    @Override	
	public IEObjectConsumer tryConsume() {
		if((value = eObjectConsumer.getConsumable("Mac_S",true)) == null) return null;
		IEObjectConsumer obj = eObjectConsumer.cloneAndConsume("Mac_S");
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			IEObjectConsumer param = createEObjectConsumer((EObject)value);
			if(param.isInstanceOf(grammarAccess.getMacro_SIGNALRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getPrimaryAccess().getMac_SMacro_SIGNALParserRuleCall_10_0(); 
				consumed = obj;
				return param;
			}
		}
...
protected class Primary_Component_referenceAssignment_11 extends AssignmentToken  {
	
	public Primary_Component_referenceAssignment_11(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getPrimaryAccess().getComponent_referenceAssignment_11();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getComponent_referenceRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getPrimaryAccess().getComponent_referenceComponent_referenceParserRuleCall_11_0(); 
				consumed = obj;
				return param;
			}
		}
...
protected class Primary_Group_12 extends GroupToken {
	
	public Primary_Group_12(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getPrimaryAccess().getGroup_12();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Primary_RightParenthesisKeyword_12_2(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// "("
protected class Primary_LeftParenthesisKeyword_12_0 extends KeywordToken  {
	
	public Primary_LeftParenthesisKeyword_12_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getPrimaryAccess().getLeftParenthesisKeyword_12_0();
	}
...
// output_expr_list=output_expression_list
protected class Primary_Output_expr_listAssignment_12_1 extends AssignmentToken  {
	
	public Primary_Output_expr_listAssignment_12_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getPrimaryAccess().getOutput_expr_listAssignment_12_1();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getOutput_expression_listRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getPrimaryAccess().getOutput_expr_listOutput_expression_listParserRuleCall_12_1_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new Primary_LeftParenthesisKeyword_12_0(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// ")"
protected class Primary_RightParenthesisKeyword_12_2 extends KeywordToken  {
	
	public Primary_RightParenthesisKeyword_12_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getPrimaryAccess().getRightParenthesisKeyword_12_2();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Primary_Output_expr_listAssignment_12_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
protected class Primary_Group_13 extends GroupToken {
	
	public Primary_Group_13(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getPrimaryAccess().getGroup_13();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Primary_RightSquareBracketKeyword_13_3(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// "["
protected class Primary_LeftSquareBracketKeyword_13_0 extends KeywordToken  {
	
	public Primary_LeftSquareBracketKeyword_13_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getPrimaryAccess().getLeftSquareBracketKeyword_13_0();
	}
...
protected class Primary_Expre_listAssignment_13_1 extends AssignmentToken  {
	
	public Primary_Expre_listAssignment_13_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getPrimaryAccess().getExpre_listAssignment_13_1();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getExpression_listRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getPrimaryAccess().getExpre_listExpression_listParserRuleCall_13_1_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new Primary_LeftSquareBracketKeyword_13_0(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
protected class Primary_Group_13_2 extends GroupToken {
	
	public Primary_Group_13_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getPrimaryAccess().getGroup_13_2();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Primary_Expression_listAssignment_13_2_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// ";"
protected class Primary_SemicolonKeyword_13_2_0 extends KeywordToken  {
	
	public Primary_SemicolonKeyword_13_2_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getPrimaryAccess().getSemicolonKeyword_13_2_0();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Primary_Group_13_2(lastRuleCallOrigin, this, 0, inst);
			case 1: return new Primary_Expre_listAssignment_13_1(lastRuleCallOrigin, this, 1, inst);
			default: return null;
		}	
	}
...
// Expression_list+=expression_list
protected class Primary_Expression_listAssignment_13_2_1 extends AssignmentToken  {
	
	public Primary_Expression_listAssignment_13_2_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getPrimaryAccess().getExpression_listAssignment_13_2_1();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getExpression_listRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getPrimaryAccess().getExpression_listExpression_listParserRuleCall_13_2_1_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new Primary_SemicolonKeyword_13_2_0(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// "]"
protected class Primary_RightSquareBracketKeyword_13_3 extends KeywordToken  {
	
	public Primary_RightSquareBracketKeyword_13_3(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getPrimaryAccess().getRightSquareBracketKeyword_13_3();
	}
...
protected class Primary_Group_14 extends GroupToken {
	
	public Primary_Group_14(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getPrimaryAccess().getGroup_14();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Primary_RightCurlyBracketKeyword_14_2(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// "{"
protected class Primary_LeftCurlyBracketKeyword_14_0 extends KeywordToken  {
	
	public Primary_LeftCurlyBracketKeyword_14_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getPrimaryAccess().getLeftCurlyBracketKeyword_14_0();
	}
...
// f_arguments=function_arguments
protected class Primary_F_argumentsAssignment_14_1 extends AssignmentToken  {
	
	public Primary_F_argumentsAssignment_14_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getPrimaryAccess().getF_argumentsAssignment_14_1();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getFunction_argumentsRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getPrimaryAccess().getF_argumentsFunction_argumentsParserRuleCall_14_1_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new Primary_LeftCurlyBracketKeyword_14_0(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// "}"
protected class Primary_RightCurlyBracketKeyword_14_2 extends KeywordToken  {
	
	public Primary_RightCurlyBracketKeyword_14_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getPrimaryAccess().getRightCurlyBracketKeyword_14_2();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Primary_F_argumentsAssignment_14_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// End="end"
protected class Primary_EndAssignment_15 extends AssignmentToken  {
	
	public Primary_EndAssignment_15(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getPrimaryAccess().getEndAssignment_15();
	}
...
// "AFTER" "(" (int=INT | num=UNSIGNED_NUMBER | Component_reference=component_reference) ")"
protected class Macro_After_Group extends GroupToken {
	
	public Macro_After_Group(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getMacro_AfterAccess().getGroup();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_After_RightParenthesisKeyword_3(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
    ...
    @Override
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getMacro_AfterRule().getType().getClassifier())
			return null;
		return eObjectConsumer;
	}
...
// "AFTER"
protected class Macro_After_AFTERKeyword_0 extends KeywordToken  {
	
	public Macro_After_AFTERKeyword_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getMacro_AfterAccess().getAFTERKeyword_0();
	}
...
// "("
protected class Macro_After_LeftParenthesisKeyword_1 extends KeywordToken  {
	
	public Macro_After_LeftParenthesisKeyword_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getMacro_AfterAccess().getLeftParenthesisKeyword_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_After_AFTERKeyword_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
protected class Macro_After_Alternatives_2 extends AlternativesToken {

	public Macro_After_Alternatives_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Alternatives getGrammarElement() {
		return grammarAccess.getMacro_AfterAccess().getAlternatives_2();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_After_IntAssignment_2_0(lastRuleCallOrigin, this, 0, inst);
			case 1: return new Macro_After_NumAssignment_2_1(lastRuleCallOrigin, this, 1, inst);
			case 2: return new Macro_After_Component_referenceAssignment_2_2(lastRuleCallOrigin, this, 2, inst);
			default: return null;
		}	
	}
...
// int=INT
protected class Macro_After_IntAssignment_2_0 extends AssignmentToken  {
	
	public Macro_After_IntAssignment_2_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getMacro_AfterAccess().getIntAssignment_2_0();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_After_LeftParenthesisKeyword_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		if((value = eObjectConsumer.getConsumable("int",true)) == null) return null;
		IEObjectConsumer obj = eObjectConsumer.cloneAndConsume("int");
		if(valueSerializer.isValid(obj.getEObject(), grammarAccess.getMacro_AfterAccess().getIntINTTerminalRuleCall_2_0_0(), value, null)) {
			type = AssignmentType.TERMINAL_RULE_CALL;
			element = grammarAccess.getMacro_AfterAccess().getIntINTTerminalRuleCall_2_0_0();
			return obj;
		}
		return null;
	}
...
// num=UNSIGNED_NUMBER
protected class Macro_After_NumAssignment_2_1 extends AssignmentToken  {
	
	public Macro_After_NumAssignment_2_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getMacro_AfterAccess().getNumAssignment_2_1();
	}
	...
	public IEObjectConsumer tryConsume() {
		if((value = eObjectConsumer.getConsumable("num",true)) == null) return null;
		IEObjectConsumer obj = eObjectConsumer.cloneAndConsume("num");
		if(valueSerializer.isValid(obj.getEObject(), grammarAccess.getMacro_AfterAccess().getNumUNSIGNED_NUMBERTerminalRuleCall_2_1_0(), value, null)) {
			type = AssignmentType.TERMINAL_RULE_CALL;
			element = grammarAccess.getMacro_AfterAccess().getNumUNSIGNED_NUMBERTerminalRuleCall_2_1_0();
			return obj;
		}
		return null;
	}
...
// Component_reference=component_reference
protected class Macro_After_Component_referenceAssignment_2_2 extends AssignmentToken  {
	
	public Macro_After_Component_referenceAssignment_2_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getMacro_AfterAccess().getComponent_referenceAssignment_2_2();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getComponent_referenceRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getMacro_AfterAccess().getComponent_referenceComponent_referenceParserRuleCall_2_2_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new Macro_After_LeftParenthesisKeyword_1(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// ")"
protected class Macro_After_RightParenthesisKeyword_3 extends KeywordToken  {
	
	public Macro_After_RightParenthesisKeyword_3(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getMacro_AfterAccess().getRightParenthesisKeyword_3();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_After_Alternatives_2(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
/************ end Rule Macro_After ****************/


/************ begin Rule Macro_BEFORE ****************
 *
 * Macro_BEFORE:
...
// "BEFORE" "(" (int=INT | num=UNSIGNED_NUMBER | Component_reference=component_reference) ")"
protected class Macro_BEFORE_Group extends GroupToken {
	
	public Macro_BEFORE_Group(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getMacro_BEFOREAccess().getGroup();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_BEFORE_RightParenthesisKeyword_3(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
    ...
    @Override
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getMacro_BEFORERule().getType().getClassifier())
			return null;
		return eObjectConsumer;
	}
...
// "BEFORE"
protected class Macro_BEFORE_BEFOREKeyword_0 extends KeywordToken  {
	
	public Macro_BEFORE_BEFOREKeyword_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getMacro_BEFOREAccess().getBEFOREKeyword_0();
	}
...
// "("
protected class Macro_BEFORE_LeftParenthesisKeyword_1 extends KeywordToken  {
	
	public Macro_BEFORE_LeftParenthesisKeyword_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getMacro_BEFOREAccess().getLeftParenthesisKeyword_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_BEFORE_BEFOREKeyword_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// int=INT | num=UNSIGNED_NUMBER | Component_reference=component_reference
protected class Macro_BEFORE_Alternatives_2 extends AlternativesToken {

	public Macro_BEFORE_Alternatives_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Alternatives getGrammarElement() {
		return grammarAccess.getMacro_BEFOREAccess().getAlternatives_2();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_BEFORE_IntAssignment_2_0(lastRuleCallOrigin, this, 0, inst);
			case 1: return new Macro_BEFORE_NumAssignment_2_1(lastRuleCallOrigin, this, 1, inst);
			case 2: return new Macro_BEFORE_Component_referenceAssignment_2_2(lastRuleCallOrigin, this, 2, inst);
			default: return null;
		}	
	}
...
// int=INT
protected class Macro_BEFORE_IntAssignment_2_0 extends AssignmentToken  {
	
	public Macro_BEFORE_IntAssignment_2_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getMacro_BEFOREAccess().getIntAssignment_2_0();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_BEFORE_LeftParenthesisKeyword_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		if((value = eObjectConsumer.getConsumable("int",true)) == null) return null;
		IEObjectConsumer obj = eObjectConsumer.cloneAndConsume("int");
		if(valueSerializer.isValid(obj.getEObject(), grammarAccess.getMacro_BEFOREAccess().getIntINTTerminalRuleCall_2_0_0(), value, null)) {
			type = AssignmentType.TERMINAL_RULE_CALL;
			element = grammarAccess.getMacro_BEFOREAccess().getIntINTTerminalRuleCall_2_0_0();
			return obj;
		}
		return null;
	}
...
// num=UNSIGNED_NUMBER
protected class Macro_BEFORE_NumAssignment_2_1 extends AssignmentToken  {
	
	public Macro_BEFORE_NumAssignment_2_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getMacro_BEFOREAccess().getNumAssignment_2_1();
	}
	...
	public IEObjectConsumer tryConsume() {
		if((value = eObjectConsumer.getConsumable("num",true)) == null) return null;
		IEObjectConsumer obj = eObjectConsumer.cloneAndConsume("num");
		if(valueSerializer.isValid(obj.getEObject(), grammarAccess.getMacro_BEFOREAccess().getNumUNSIGNED_NUMBERTerminalRuleCall_2_1_0(), value, null)) {
			type = AssignmentType.TERMINAL_RULE_CALL;
			element = grammarAccess.getMacro_BEFOREAccess().getNumUNSIGNED_NUMBERTerminalRuleCall_2_1_0();
			return obj;
		}
		return null;
	}
...
// Component_reference=component_reference
protected class Macro_BEFORE_Component_referenceAssignment_2_2 extends AssignmentToken  {
	
	public Macro_BEFORE_Component_referenceAssignment_2_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getMacro_BEFOREAccess().getComponent_referenceAssignment_2_2();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getComponent_referenceRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getMacro_BEFOREAccess().getComponent_referenceComponent_referenceParserRuleCall_2_2_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new Macro_BEFORE_LeftParenthesisKeyword_1(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// ")"
protected class Macro_BEFORE_RightParenthesisKeyword_3 extends KeywordToken  {
	
	public Macro_BEFORE_RightParenthesisKeyword_3(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getMacro_BEFOREAccess().getRightParenthesisKeyword_3();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_BEFORE_Alternatives_2(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
/************ end Rule Macro_BEFORE ****************/


/************ begin Rule Macro_SIGNAL ****************
 *
 * Macro_SIGNAL:
...
// "SIGNAL" "(" Component_reference=component_reference ")"
protected class Macro_SIGNAL_Group extends GroupToken {
	
	public Macro_SIGNAL_Group(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getMacro_SIGNALAccess().getGroup();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_SIGNAL_RightParenthesisKeyword_3(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
    ...
    @Override
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getMacro_SIGNALRule().getType().getClassifier())
			return null;
		return eObjectConsumer;
	}
...
// "SIGNAL"
protected class Macro_SIGNAL_SIGNALKeyword_0 extends KeywordToken  {
	
	public Macro_SIGNAL_SIGNALKeyword_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getMacro_SIGNALAccess().getSIGNALKeyword_0();
	}
...
// "("
protected class Macro_SIGNAL_LeftParenthesisKeyword_1 extends KeywordToken  {
	
	public Macro_SIGNAL_LeftParenthesisKeyword_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getMacro_SIGNALAccess().getLeftParenthesisKeyword_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_SIGNAL_SIGNALKeyword_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// Component_reference=component_reference
protected class Macro_SIGNAL_Component_referenceAssignment_2 extends AssignmentToken  {
	
	public Macro_SIGNAL_Component_referenceAssignment_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getMacro_SIGNALAccess().getComponent_referenceAssignment_2();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getComponent_referenceRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getMacro_SIGNALAccess().getComponent_referenceComponent_referenceParserRuleCall_2_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new Macro_SIGNAL_LeftParenthesisKeyword_1(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// ")"
protected class Macro_SIGNAL_RightParenthesisKeyword_3 extends KeywordToken  {
	
	public Macro_SIGNAL_RightParenthesisKeyword_3(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getMacro_SIGNALAccess().getRightParenthesisKeyword_3();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_SIGNAL_Component_referenceAssignment_2(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
/************ end Rule Macro_SIGNAL ****************/


/************ begin Rule Macro_EVENT ****************
 *
 * Macro_EVENT:
...
// "EVENT" "(" Component_reference=component_reference ")"
protected class Macro_EVENT_Group extends GroupToken {
	
	public Macro_EVENT_Group(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getMacro_EVENTAccess().getGroup();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_EVENT_RightParenthesisKeyword_3(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
    ...
    @Override
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getMacro_EVENTRule().getType().getClassifier())
			return null;
		return eObjectConsumer;
	}
...
// "EVENT"
protected class Macro_EVENT_EVENTKeyword_0 extends KeywordToken  {
	
	public Macro_EVENT_EVENTKeyword_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getMacro_EVENTAccess().getEVENTKeyword_0();
	}
...
// "("
protected class Macro_EVENT_LeftParenthesisKeyword_1 extends KeywordToken  {
	
	public Macro_EVENT_LeftParenthesisKeyword_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getMacro_EVENTAccess().getLeftParenthesisKeyword_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_EVENT_EVENTKeyword_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// Component_reference=component_reference
protected class Macro_EVENT_Component_referenceAssignment_2 extends AssignmentToken  {
	
	public Macro_EVENT_Component_referenceAssignment_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getMacro_EVENTAccess().getComponent_referenceAssignment_2();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getComponent_referenceRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getMacro_EVENTAccess().getComponent_referenceComponent_referenceParserRuleCall_2_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new Macro_EVENT_LeftParenthesisKeyword_1(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// ")"
protected class Macro_EVENT_RightParenthesisKeyword_3 extends KeywordToken  {
	
	public Macro_EVENT_RightParenthesisKeyword_3(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getMacro_EVENTAccess().getRightParenthesisKeyword_3();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_EVENT_Component_referenceAssignment_2(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
/************ end Rule Macro_EVENT ****************/


/************ begin Rule Macro_CHANGE ****************
 *
 * Macro_CHANGE:
...
// "CHANGE" "(" Component_reference=component_reference ")"
protected class Macro_CHANGE_Group extends GroupToken {
	
	public Macro_CHANGE_Group(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getMacro_CHANGEAccess().getGroup();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_CHANGE_RightParenthesisKeyword_3(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
    ...
    @Override
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getMacro_CHANGERule().getType().getClassifier())
			return null;
		return eObjectConsumer;
	}
...
// "CHANGE"
protected class Macro_CHANGE_CHANGEKeyword_0 extends KeywordToken  {
	
	public Macro_CHANGE_CHANGEKeyword_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getMacro_CHANGEAccess().getCHANGEKeyword_0();
	}
...
// "("
protected class Macro_CHANGE_LeftParenthesisKeyword_1 extends KeywordToken  {
	
	public Macro_CHANGE_LeftParenthesisKeyword_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getMacro_CHANGEAccess().getLeftParenthesisKeyword_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_CHANGE_CHANGEKeyword_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// Component_reference=component_reference
protected class Macro_CHANGE_Component_referenceAssignment_2 extends AssignmentToken  {
	
	public Macro_CHANGE_Component_referenceAssignment_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getMacro_CHANGEAccess().getComponent_referenceAssignment_2();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getComponent_referenceRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getMacro_CHANGEAccess().getComponent_referenceComponent_referenceParserRuleCall_2_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new Macro_CHANGE_LeftParenthesisKeyword_1(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// ")"
protected class Macro_CHANGE_RightParenthesisKeyword_3 extends KeywordToken  {
	
	public Macro_CHANGE_RightParenthesisKeyword_3(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getMacro_CHANGEAccess().getRightParenthesisKeyword_3();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Macro_CHANGE_Component_referenceAssignment_2(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
