...
public class AbstractStatetransitionguardexpressionSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (StatetransitionguardexpressionGrammarAccess) access;
