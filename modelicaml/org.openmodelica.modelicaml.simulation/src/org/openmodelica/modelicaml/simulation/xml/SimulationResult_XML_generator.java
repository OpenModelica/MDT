...
public class SimulationResult_XML_generator {
	 ...
	 * @param resultXMLabsPath folder where the result.xml file should be stored after generating it
	 * @throws Exception the exception
	 */
	public static void createXML(String pathToResult, String resultXMLabsPath) throws Exception {
