 ...
 */
public class SessionConfiguration_ChangeModelInteractiveWizardPage extends WizardPage {
	...
	/** The button check plot. */
	private Button buttonCheckPlot;
	
	/** The button check interactive. */
	private Button buttonCheckInteractive;
...
//	private ModelicaModel initialModelicaModel; //TODO [201009] implementieren aber niedrige prio
	 ...
	 */
	protected SessionConfiguration_ChangeModelInteractiveWizardPage(String pageName) {
		super(pageName);
	}
	 ...
	 */
	protected SessionConfiguration_ChangeModelInteractiveWizardPage(String pageName, ModelicaModel sampleModelicaModel, String option) {
		super(pageName);
		this.option = option;
		setTitle("Prepare an interactive simulation session: Model Configuration");
...
//						compositePropertyDataContainer = new SessionConfiguration_ChangeModel_DoubleValueComposite(compositeSelectedValueData, SWT.NONE);
					...
					}
					{
						...
						buttonRestore.setText("Restore to Default");
						...
						if(option.equals("change") || option.equals("use"))
							buttonRestore.setToolTipText("Restores the previews value for this property");
						else
							buttonRestore.setToolTipText("Restores the initial value for this property");
			...
			}
			{
				...
				compositeButtons.setLayout(compositeButtonsLayout);
				{
					...
					if(option.equals("change") || option.equals("use"))
						buttonRestoreAll.setToolTipText("Restores all preview values for the properties");
					else
						buttonRestoreAll.setToolTipText("Restores all initial values for the properties");
