...
package org.openmodelica.modelicaml.editor.xtext.array.services;
...
@Singleton
public class ArraysubscriptGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class SubscriptElements extends AbstractParserRuleElementFinder {
		...
		////subscript :{subscript}
		////(':' | expr=expression)    changed to optiotnal to avoid errors
		////;
		//subscript:
	...
	@Inject
	public ArraysubscriptGrammarAccess(GrammarProvider grammarProvider,
