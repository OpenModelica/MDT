...
* generated by Xtext
*/
package org.openmodelica.modelicaml.editor.xtext.array.parseTreeConstruction;
...
public class ArraysubscriptParsetreeConstructor extends AbstractParseTreeConstructor {
...
protected class ThisRootNode extends RootToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Subscript_Group(this, this, 0, inst);
			case 1: return new Expression_Alternatives(this, this, 1, inst);
			case 2: return new Simple_expression_Group(this, this, 2, inst);
			case 3: return new Conditional_expr_Group(this, this, 3, inst);
			case 4: return new Logical_expression_Group(this, this, 4, inst);
			case 5: return new Logical_term_Group(this, this, 5, inst);
			case 6: return new Logical_factor_Group(this, this, 6, inst);
			case 7: return new Relation_Group(this, this, 7, inst);
			case 8: return new Arithmetic_expression_Group(this, this, 8, inst);
			case 9: return new Term_Group(this, this, 9, inst);
			case 10: return new Factor_Group(this, this, 10, inst);
			case 11: return new Primary_Alternatives(this, this, 11, inst);
			case 12: return new Name_Function_Group(this, this, 12, inst);
			case 13: return new Initial_ref_Group(this, this, 13, inst);
			case 14: return new ExprDer_Group(this, this, 14, inst);
			case 15: return new Function_call_args_Group(this, this, 15, inst);
			case 16: return new Expression_list_Group(this, this, 16, inst);
			case 17: return new Name_Group(this, this, 17, inst);
			case 18: return new Component_reference_Group(this, this, 18, inst);
...
// {subscript} (":" | expr=expression)?
protected class Subscript_Group extends GroupToken {
	
	public Subscript_Group(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getSubscriptAccess().getGroup();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Subscript_Alternatives_1(lastRuleCallOrigin, this, 0, inst);
			case 1: return new Subscript_SubscriptAction_0(lastRuleCallOrigin, this, 1, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getSubscriptAccess().getSubscriptAction_0().getType().getClassifier())
			return null;
...
// {subscript}
protected class Subscript_SubscriptAction_0 extends ActionToken  {

	public Subscript_SubscriptAction_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Action getGrammarElement() {
		return grammarAccess.getSubscriptAccess().getSubscriptAction_0();
	}
...
// (":" | expr=expression)?
protected class Subscript_Alternatives_1 extends AlternativesToken {

	public Subscript_Alternatives_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Alternatives getGrammarElement() {
		return grammarAccess.getSubscriptAccess().getAlternatives_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Subscript_ExprAssignment_1_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// expr=expression
protected class Subscript_ExprAssignment_1_1 extends AssignmentToken  {
	
	public Subscript_ExprAssignment_1_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getSubscriptAccess().getExprAssignment_1_1();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getExpressionRule().getType().getClassifier())) {
				...
				element = grammarAccess.getSubscriptAccess().getExprExpressionParserRuleCall_1_1_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		...
		switch(index) {
			case 0: return new Subscript_SubscriptAction_0(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
