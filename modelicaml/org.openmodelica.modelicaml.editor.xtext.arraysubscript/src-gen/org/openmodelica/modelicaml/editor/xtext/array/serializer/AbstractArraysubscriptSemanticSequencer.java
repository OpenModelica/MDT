...
public class AbstractArraysubscriptSemanticSequencer extends AbstractSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == ArraysubscriptPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case ArraysubscriptPackage.SUBSCRIPT:
