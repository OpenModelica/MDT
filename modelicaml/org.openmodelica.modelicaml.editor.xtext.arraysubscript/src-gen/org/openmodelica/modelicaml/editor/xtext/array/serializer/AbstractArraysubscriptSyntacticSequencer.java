package org.openmodelica.modelicaml.editor.xtext.array.serializer;
...
public class AbstractArraysubscriptSyntacticSequencer extends AbstractSyntacticSequencer {

	protected ArraysubscriptGrammarAccess grammarAccess;
	...
	protected AbstractElementAlias match_subscript_ColonKeyword_1_0_q;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (ArraysubscriptGrammarAccess) access;
		...
		match_subscript_ColonKeyword_1_0_q = new TokenAlias(true, false, grammarAccess.getSubscriptAccess().getColonKeyword_1_0());
	}
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_subscript_ColonKeyword_1_0_q.equals(syntax))
				emit_subscript_ColonKeyword_1_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     ':'?
	 */
	protected void emit_subscript_ColonKeyword_1_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
