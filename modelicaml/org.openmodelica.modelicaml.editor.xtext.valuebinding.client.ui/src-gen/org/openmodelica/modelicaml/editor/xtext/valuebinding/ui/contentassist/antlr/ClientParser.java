		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPrimaryAccess().getGroup_15(), "rule__Primary__Group_15__0");
					put(grammarAccess.getPrimaryAccess().getGroup_16(), "rule__Primary__Group_16__0");
					put(grammarAccess.getPrimaryAccess().getGroup_16_2(), "rule__Primary__Group_16_2__0");
					put(grammarAccess.getPrimaryAccess().getGroup_17(), "rule__Primary__Group_17__0");
					...
					put(grammarAccess.getGetResultFunctionAccess().getGroup(), "rule__GetResultFunction__Group__0");
					...
					put(grammarAccess.getPrimaryAccess().getAvrAssignment_11(), "rule__Primary__AvrAssignment_11");
					put(grammarAccess.getPrimaryAccess().getSizeAssignment_12(), "rule__Primary__SizeAssignment_12");
					put(grammarAccess.getPrimaryAccess().getResultAssignment_13(), "rule__Primary__ResultAssignment_13");
					put(grammarAccess.getPrimaryAccess().getComponent_referenceAssignment_14(), "rule__Primary__Component_referenceAssignment_14");
					put(grammarAccess.getPrimaryAccess().getOutput_expr_listAssignment_15_1(), "rule__Primary__Output_expr_listAssignment_15_1");
					put(grammarAccess.getPrimaryAccess().getExpre_listAssignment_16_1(), "rule__Primary__Expre_listAssignment_16_1");
					put(grammarAccess.getPrimaryAccess().getExpression_listAssignment_16_2_1(), "rule__Primary__Expression_listAssignment_16_2_1");
					put(grammarAccess.getPrimaryAccess().getF_argumentsAssignment_17_1(), "rule__Primary__F_argumentsAssignment_17_1");
					put(grammarAccess.getPrimaryAccess().getEndAssignment_18(), "rule__Primary__EndAssignment_18");
