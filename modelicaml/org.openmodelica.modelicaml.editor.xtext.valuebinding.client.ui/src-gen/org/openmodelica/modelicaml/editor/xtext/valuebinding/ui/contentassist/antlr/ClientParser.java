...
public class ClientParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.openmodelica.modelicaml.editor.xtext.valuebinding.ui.contentassist.antlr.internal.InternalClientParser createParser() {
		org.openmodelica.modelicaml.editor.xtext.valuebinding.ui.contentassist.antlr.internal.InternalClientParser result = new org.openmodelica.modelicaml.editor.xtext.valuebinding.ui.contentassist.antlr.internal.InternalClientParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getClientOperationAccess().getGroup(), "rule__ClientOperation__Group__0");
					...
					put(grammarAccess.getPrimaryAccess().getGroup_10_2(), "rule__Primary__Group_10_2__0");
					put(grammarAccess.getPrimaryAccess().getGroup_11(), "rule__Primary__Group_11__0");
					put(grammarAccess.getGetBindingFunctionAccess().getGroup(), "rule__GetBindingFunction__Group__0");
					...
					put(grammarAccess.getClientOperationAccess().getLeft_handAssignment_0(), "rule__ClientOperation__Left_handAssignment_0");
					put(grammarAccess.getClientOperationAccess().getExprAssignment_2(), "rule__ClientOperation__ExprAssignment_2");
					...
					put(grammarAccess.getPrimaryAccess().getBindingAssignment_7(), "rule__Primary__BindingAssignment_7");
					put(grammarAccess.getPrimaryAccess().getComponent_referenceAssignment_8(), "rule__Primary__Component_referenceAssignment_8");
					put(grammarAccess.getPrimaryAccess().getOutput_expr_listAssignment_9_1(), "rule__Primary__Output_expr_listAssignment_9_1");
					put(grammarAccess.getPrimaryAccess().getExpre_listAssignment_10_1(), "rule__Primary__Expre_listAssignment_10_1");
					put(grammarAccess.getPrimaryAccess().getExpression_listAssignment_10_2_1(), "rule__Primary__Expression_listAssignment_10_2_1");
					put(grammarAccess.getPrimaryAccess().getF_argumentsAssignment_11_1(), "rule__Primary__F_argumentsAssignment_11_1");
					put(grammarAccess.getPrimaryAccess().getEndAssignment_12(), "rule__Primary__EndAssignment_12");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.openmodelica.modelicaml.editor.xtext.valuebinding.ui.contentassist.antlr.internal.InternalClientParser typedParser = (org.openmodelica.modelicaml.editor.xtext.valuebinding.ui.contentassist.antlr.internal.InternalClientParser) parser;
			typedParser.entryRuleClientOperation();
