...
entryRuleactivityControlFlowExpression returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getActivityControlFlowExpressionRule()); }
	 ...
	 { $current=$iv_ruleactivityControlFlowExpression.current; } 
	 EOF 
;

// Rule activityControlFlowExpression
ruleactivityControlFlowExpression returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
