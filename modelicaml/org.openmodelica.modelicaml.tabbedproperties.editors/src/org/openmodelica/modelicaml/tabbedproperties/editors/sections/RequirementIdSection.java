...
/**
 * The Class RequirementIdSection.
 */
public class RequirementIdSection extends AbstractSingleStringSection {

	/**
	 * Instantiates a new requirement id section.
	 */
	public RequirementIdSection() {
		super();
		//stereotypPropertieName = ModelicaMLProperties.s_p_id;
		stereotypPropertieName = "id";
	}
