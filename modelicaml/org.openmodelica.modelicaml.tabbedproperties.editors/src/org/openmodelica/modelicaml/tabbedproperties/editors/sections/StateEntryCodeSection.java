 ...
 */
public class StateEntryCodeSection extends AbstractPropertySection  {
	/** The LANGUAGE. */
	...
	private final String stateActionKind = "entry"; 
...
//		editingDomain = EditorUtils.getTransactionalEditingDomain();
	...
	public void refresh() {
		if (isNewSelection && isValidElement() ) { // Only react if a different (new) element was selected
			...
			//############## Adjust here: start
			Behavior definedBehavior = ((State)selectedState).getEntry();
