...
/**
 * The Class ExtendsModificationsSection.
 */
public class ExtendsModificationsSection extends AbstractMultiStringSection {

	/**
	 * Instantiates a new extends modifications section.
	 */
	public ExtendsModificationsSection() {
		super();
		stereotypPropertieName = "modification"; 
	}
