...
/**
 * The Class ConditionalExpressionPropertySectionEditorFilter.
 */
public class ConditionalExpressionPropertySectionEditorFilter extends UmlElementFilter {
	...
	public boolean select(Object object) {
		...
		if ( element instanceof Property 
				...
				&& ( ((Property)element).getAppliedStereotype("ModelicaML::ModelicaCompositeConstructs::Variable") != null
					|| ((Property)element).getAppliedStereotype("ModelicaML::ModelicaCompositeConstructs::Component") != null
					|| ((Property)element).getAppliedStereotype("ModelicaML::ModelicaCompositeConstructs::ConnectionPort") != null
					|| ((Property)element).getAppliedStereotype("ModelicaML::ModelicaCompositeConstructs::RequirementInstance") != null
		...
		if ( element instanceof Parameter 
				&& ((Parameter)element).getAppliedStereotype("ModelicaML::ModelicaCompositeConstructs::FunctionArgument") != null){
			return true; 
		}
