package org.openmodelica.modelicaml.editor.xtext.model.serializer;
...
public class AbstractModeleditorSemanticSequencer extends AbstractSemanticSequencer {
	...
	protected void sequence_Fun_Arguments_exp(EObject context, Fun_Arguments_exp semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, ModeleditorPackage.Literals.FUN_ARGUMENTS_EXP__ARGS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ModeleditorPackage.Literals.FUN_ARGUMENTS_EXP__ARGS));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getFun_Arguments_expAccess().getArgsFunction_argumentsParserRuleCall_1_0(), semanticObject.getArgs());
		feeder.finish();
	}
	...
	protected void sequence_Fun_Arguments_for(EObject context, Fun_Arguments_for semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, ModeleditorPackage.Literals.FUN_ARGUMENTS_FOR__FOR_INDICES) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ModeleditorPackage.Literals.FUN_ARGUMENTS_FOR__FOR_INDICES));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getFun_Arguments_forAccess().getFor_indicesFor_indicesParserRuleCall_1_0(), semanticObject.getFor_indices());
		feeder.finish();
	}
	...
	protected void sequence_expression(EObject context, expression semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, ModeleditorPackage.Literals.EXPRESSION__EXPR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ModeleditorPackage.Literals.EXPRESSION__EXPR));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getExpressionAccess().getExprSimple_expressionParserRuleCall_0_0(), semanticObject.getExpr());
		feeder.finish();
	}
