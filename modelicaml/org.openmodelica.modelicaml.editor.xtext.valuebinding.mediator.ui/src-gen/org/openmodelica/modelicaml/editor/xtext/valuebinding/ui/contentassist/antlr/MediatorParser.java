		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPrimaryAccess().getGroup_17_2(), "rule__Primary__Group_17_2__0");
					put(grammarAccess.getPrimaryAccess().getGroup_18(), "rule__Primary__Group_18__0");
					...
					put(grammarAccess.getPrimaryAccess().getSingleProviderAssignment_14(), "rule__Primary__SingleProviderAssignment_14");
					put(grammarAccess.getPrimaryAccess().getComponent_referenceAssignment_15(), "rule__Primary__Component_referenceAssignment_15");
					put(grammarAccess.getPrimaryAccess().getOutput_expr_listAssignment_16_1(), "rule__Primary__Output_expr_listAssignment_16_1");
					put(grammarAccess.getPrimaryAccess().getExpre_listAssignment_17_1(), "rule__Primary__Expre_listAssignment_17_1");
					put(grammarAccess.getPrimaryAccess().getExpression_listAssignment_17_2_1(), "rule__Primary__Expression_listAssignment_17_2_1");
					put(grammarAccess.getPrimaryAccess().getF_argumentsAssignment_18_1(), "rule__Primary__F_argumentsAssignment_18_1");
					put(grammarAccess.getPrimaryAccess().getEndAssignment_19(), "rule__Primary__EndAssignment_19");
