...
public class SysmlPaletteFactory {
	...
	private ToolEntry createClasspart1CreationTool() {
		...
		ToolEntry result = new ToolEntry("Class part", "Create Class Part",
				smallImage, largeImage) {
		};
	...
	private ToolEntry createConnection1CreationTool() {
		...
		ToolEntry result = new ToolEntry("Connection",
	...
	private ToolEntry createNestedClass1CreationTool() {
		...
		smallImage = SysmlElementTypes
				.getImageDescriptor(SysmlElementTypes.ModelicaClass_2004);

		largeImage = smallImage;

		final List elementTypes = new ArrayList();
		elementTypes.add(SysmlElementTypes.ModelicaClass_2004);
	...
	private ToolEntry createNestedModel2CreationTool() {
		...
		smallImage = SysmlElementTypes
				.getImageDescriptor(SysmlElementTypes.ModelicaModel_2004);

		largeImage = smallImage;

		final List elementTypes = new ArrayList();
		elementTypes.add(SysmlElementTypes.ModelicaModel_2004);
	...
	private ToolEntry createNestedBlock3CreationTool() {
		...
		smallImage = SysmlElementTypes
				.getImageDescriptor(SysmlElementTypes.ModelicaBlock_2004);

		largeImage = smallImage;

		final List elementTypes = new ArrayList();
		elementTypes.add(SysmlElementTypes.ModelicaBlock_2004);
	...
	private ToolEntry createNestedConnector4CreationTool() {
		...
		smallImage = SysmlElementTypes
				.getImageDescriptor(SysmlElementTypes.ModelicaConnector_2004);

		largeImage = smallImage;

		final List elementTypes = new ArrayList();
		elementTypes.add(SysmlElementTypes.ModelicaConnector_2004);
	...
	private ToolEntry createNestedRecord5CreationTool() {
		...
		smallImage = SysmlElementTypes
				.getImageDescriptor(SysmlElementTypes.ModelicaRecord_2004);

		largeImage = smallImage;

		final List elementTypes = new ArrayList();
		elementTypes.add(SysmlElementTypes.ModelicaRecord_2004);
	...
	private ToolEntry createNestedFunction6CreationTool() {
		...
		smallImage = SysmlElementTypes
				.getImageDescriptor(SysmlElementTypes.ModelicaFunction_2004);

		largeImage = smallImage;

		final List elementTypes = new ArrayList();
		elementTypes.add(SysmlElementTypes.ModelicaFunction_2004);
		ToolEntry result = new NodeToolEntry("Function",
