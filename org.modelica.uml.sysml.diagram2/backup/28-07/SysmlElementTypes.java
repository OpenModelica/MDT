...
public class SysmlElementTypes {
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(ModelicaProperty_2003, SysmlPackage.eINSTANCE
					.getModelicaProperty());
			elements.put(ModelicaClass_2004, SysmlPackage.eINSTANCE
					.getModelicaClass());
			...
			elements.put(ModelicaModel_2004, SysmlPackage.eINSTANCE
					.getModelicaModel());
			elements.put(ModelicaBlock_2004, SysmlPackage.eINSTANCE
					.getModelicaBlock());
			elements.put(ModelicaRecord_2004, SysmlPackage.eINSTANCE
					.getModelicaRecord());
			elements.put(ModelicaConnector_2004, SysmlPackage.eINSTANCE
					.getModelicaConnector());
			elements.put(ModelicaFunction_2004, SysmlPackage.eINSTANCE
					.getModelicaFunction());
		}
	 ...
	 * @generated
	 */
	public static final IElementType ModelicaClass_2004 = getElementType("org.modelica.uml.sysml.diagram2.ModelicaClass_2004"); //$NON-NLS-1$

	//contributed code start
	/**
	 */
	public static final IElementType ModelicaModel_2004 = getElementType("org.modelica.uml.sysml.diagram2.ModelicaModel_2004"); //$NON-NLS-1$

	/**
	 */
	public static final IElementType ModelicaBlock_2004 = getElementType("org.modelica.uml.sysml.diagram2.ModelicaBlock_2004"); //$NON-NLS-1$

	/**
	 */
	public static final IElementType ModelicaRecord_2004 = getElementType("org.modelica.uml.sysml.diagram2.ModelicaRecord_2004"); //$NON-NLS-1$

	/**
	 */
	public static final IElementType ModelicaConnector_2004 = getElementType("org.modelica.uml.sysml.diagram2.ModelicaConnector_2004"); //$NON-NLS-1$

	/**
	 */
	public static final IElementType ModelicaFunction_2004 = getElementType("org.modelica.uml.sysml.diagram2.ModelicaFunction_2004"); //$NON-NLS-1$	
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(ModelicaClass_2004);
			...
			KNOWN_ELEMENT_TYPES.add(ModelicaModel_2004);
			KNOWN_ELEMENT_TYPES.add(ModelicaBlock_2004);
			KNOWN_ELEMENT_TYPES.add(ModelicaRecord_2004);
			KNOWN_ELEMENT_TYPES.add(ModelicaConnector_2004);
			KNOWN_ELEMENT_TYPES.add(ModelicaFunction_2004);
		}
