 ...
 * @generated
 */
public class ModelicaClassParameters2ItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (SysmlElementTypes.ModelicaProperty_2001 == req.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(UMLPackage.eINSTANCE
						.getStructuredClassifier_OwnedAttribute());
			}
			return getMSLWrapper(new CreateModelicaProperty_2001Command(req));
		}
	 ...
	 * @generated
	 */
	private static class CreateModelicaProperty_2001Command extends
			CreateElementCommand {

		/**
		 * @generated
		 */
		public CreateModelicaProperty_2001Command(CreateElementRequest req) {
			super(req);
		}
