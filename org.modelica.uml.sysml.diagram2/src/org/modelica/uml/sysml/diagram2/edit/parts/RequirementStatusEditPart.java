 ...
 * @generated
 */
public class RequirementStatusEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RequirementStatusEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new SysmlParserProvider.HintAdapter(
					SysmlElementTypes.Requirement_1004, getParserElement(),
					parserHint);
