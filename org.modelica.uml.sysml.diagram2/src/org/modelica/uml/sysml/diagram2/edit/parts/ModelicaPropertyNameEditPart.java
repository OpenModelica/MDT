 ...
 * @generated
 */
public class ModelicaPropertyNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ModelicaPropertyNameEditPart(View view) {
		super(view);
	}
	...
	protected String getLabelText() {
		...
		text = ModelicaPropertyUtil.getSignatureStringForPart(text,
