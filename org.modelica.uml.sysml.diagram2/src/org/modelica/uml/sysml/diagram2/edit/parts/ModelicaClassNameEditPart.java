 ...
 * @generated
 */
public class ModelicaClassNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ModelicaClassNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new SysmlParserProvider.HintAdapter(
					SysmlElementTypes.ModelicaClass_2005, getParserElement(),
					parserHint);
