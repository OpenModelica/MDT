 ...
 * @generated
 */
public class ModelicaClassName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ModelicaClassName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new SysmlParserProvider.HintAdapter(
					SysmlElementTypes.ModelicaClass_1001, getParserElement(),
					parserHint);
