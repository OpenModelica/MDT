 ...
 * @generated
 */
public class SatisfiesNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SatisfiesNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new SysmlParserProvider.HintAdapter(
					SysmlElementTypes.Satisfies_1006, getParserElement(),
					parserHint);
