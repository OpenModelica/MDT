 ...
 * @generated
 */
public class ModelicaClassNested2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		EObject nextValue;
		int nodeVID;
		for (Iterator values = ((org.eclipse.uml2.uml.Class) modelObject)
				.getNestedClassifiers().iterator(); values.hasNext();) {
			nextValue = (EObject) values.next();
			nodeVID = SysmlVisualIDRegistry.getNodeVisualID(viewObject,
					nextValue);
			if (ModelicaClass2EditPart.VISUAL_ID == nodeVID) {
