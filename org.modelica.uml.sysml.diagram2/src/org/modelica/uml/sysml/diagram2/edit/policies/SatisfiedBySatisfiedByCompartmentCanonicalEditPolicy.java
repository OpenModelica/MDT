 ...
 * @generated
 */
public class SatisfiedBySatisfiedByCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		for (Iterator it = SysmlDiagramUpdater
				.getSatisfiedBySatisfiedByCompartment_5013SemanticChildren(
	...
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(SysmlPackage.eINSTANCE
