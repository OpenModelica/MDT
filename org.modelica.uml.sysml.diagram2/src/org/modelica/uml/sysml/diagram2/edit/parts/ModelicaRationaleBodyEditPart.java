 ...
 * @generated
 */
public class ModelicaRationaleBodyEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ModelicaRationaleBodyEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new SysmlParserProvider.HintAdapter(
					SysmlElementTypes.ModelicaRationale_1002,
