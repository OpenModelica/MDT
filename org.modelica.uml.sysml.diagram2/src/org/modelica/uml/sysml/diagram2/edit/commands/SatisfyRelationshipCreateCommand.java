 ...
 * @generated
 */
public class SatisfyRelationshipCreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public SatisfyRelationshipCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (target != null && !(target instanceof ModelicaClass)) {
			return false;
		}
		if (getSource() == null) {
		...
		return SysmlBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateSatisfyRelationship_3002(getContainer(), getSource(),
						getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		// org.modelica.uml.sysml.SatisfyRelationship newElement = (org.modelica.uml.sysml.SatisfyRelationship) super.doDefaultElementCreation();
		SatisfyRelationship newElement = SysmlFactory.eINSTANCE
				.createSatisfyRelationship();
		getContainer().getPackagedElements().add(newElement);
		newElement.setSource(getSource());
		newElement.setTarget(getTarget());
		SysmlElementTypes.Initializers.SatisfyRelationship_3002
				.init(newElement);
		return newElement;
	}
	 ...
	 * @generated
	 */
	protected ModelicaClass getTarget() {
		return (ModelicaClass) target;
	}
