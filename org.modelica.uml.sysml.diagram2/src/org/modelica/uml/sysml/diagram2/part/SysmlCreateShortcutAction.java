 ...
 * @generated
 */
public class SysmlCreateShortcutAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		SysmlElementChooserDialog elementChooser = new SysmlElementChooserDialog(
				myShell, view);
		...
		command = command.compose(new SysmlCreateShortcutDecorationsCommand(
