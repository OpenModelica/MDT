...
import org.modelica.uml.sysml.diagram2.edit.parts.ModelicaRationaleBodyEditPart;
 ...
 * @generated
 */
public class ModelicaRationaleViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = SysmlVisualIDRegistry
					.getType(ModelicaRationaleEditPart.VISUAL_ID);
