...
import org.modelica.uml.sysml.diagram2.edit.parts.DeriveReqRelationshipNameEditPart;
 ...
 * @generated
 */
public class DeriveReqRelationshipViewFactory extends ConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = SysmlVisualIDRegistry
					.getType(DeriveReqRelationshipEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				SysmlVisualIDRegistry
						.getType(DeriveReqRelationshipNameEditPart.VISUAL_ID),
