...
import org.modelica.uml.sysml.diagram2.edit.parts.SatisfyRelationshipNameEditPart;
 ...
 * @generated
 */
public class SatisfyRelationshipViewFactory extends ConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = SysmlVisualIDRegistry
					.getType(SatisfyRelationshipEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				SysmlVisualIDRegistry
						.getType(SatisfyRelationshipNameEditPart.VISUAL_ID),
