...
import org.modelica.uml.sysml.diagram2.edit.parts.SatisfiesNameEditPart;
 ...
 * @generated
 */
public class SatisfiesViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = SysmlVisualIDRegistry
					.getType(SatisfiesEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				SysmlVisualIDRegistry.getType(SatisfiesNameEditPart.VISUAL_ID),
