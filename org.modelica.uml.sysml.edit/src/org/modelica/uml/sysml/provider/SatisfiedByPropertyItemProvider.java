...
/**
 * This is the item provider adapter for a {@link org.modelica.uml.sysml.SatisfiedByProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SatisfiedByPropertyItemProvider
	 ...
	 * @generated
	 */
	public SatisfiedByPropertyItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SatisfiedByProperty_element_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SatisfiedByProperty_element_feature", "_UI_SatisfiedByProperty_type"),
				 SysmlPackage.Literals.SATISFIED_BY_PROPERTY__ELEMENT,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns SatisfiedByProperty.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SatisfiedByProperty"));
	}
	...
	public String getText(Object object) {
		String label = ((SatisfiedByProperty)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SatisfiedByProperty_type") :
			getString("_UI_SatisfiedByProperty_type") + " " + label;
	}
