...
/**
 * This is the item provider adapter for a {@link org.modelica.uml.sysml.SatisfiedBy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SatisfiedByItemProvider
	 ...
	 * @generated
	 */
	public SatisfiedByItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SatisfiedBy_satisfiedBy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SatisfiedBy_satisfiedBy_feature", "_UI_SatisfiedBy_type"),
				 SysmlPackage.Literals.SATISFIED_BY__SATISFIED_BY,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SysmlPackage.Literals.SATISFIED_BY__SATISFIED_BY);
		}
	...
	/**
	 * This returns SatisfiedBy.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SatisfiedBy"));
	}
	...
	public String getText(Object object) {
		String label = ((SatisfiedBy)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SatisfiedBy_type") :
			getString("_UI_SatisfiedBy_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SatisfiedBy.class)) {
