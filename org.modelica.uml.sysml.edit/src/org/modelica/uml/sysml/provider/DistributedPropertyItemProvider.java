...
/**
 * This is the item provider adapter for a {@link org.modelica.uml.sysml.DistributedProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DistributedPropertyItemProvider
	extends BlockPropertyItemProvider
	implements	
	...
	public String getText(Object object) {
		String label = ((DistributedProperty)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DistributedProperty_type") :
			getString("_UI_DistributedProperty_type") + " " + label;
	}
