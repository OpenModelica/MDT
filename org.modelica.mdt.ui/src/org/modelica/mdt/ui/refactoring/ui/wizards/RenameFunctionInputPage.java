...
/** <p>the input page for the Rename Property refactoring, where users can
  ...
  * @author Leif Frenzel
  */
public class RenameFunctionInputPage extends UserInputWizardPage {

  private static final String DS_KEY = RenameFunctionInputPage.class.getName();
...
//  private Button cbAllProjects;
  ...
  public RenameFunctionInputPage( final RenameFunctionInfo info ) {
    super( RenameFunctionInputPage.class.getName() );
    this.info = info;
    initDialogSettings();
  }
  ...
  private void createLblNewName( final Composite composite ) {
    ...
    lblNewName.setText( UITexts.renameFunctionInputPage_lblNewName );
  }
...
/*
  private void createCbUpdateBundle( final Composite composite ) {
    String texts = UITexts.renameFunctionInputPage_cbUpdateBundle;
  ...
  private void createCbAllProjects( final Composite composite ) {
    String text = UITexts.renameFunctionInputPage_cbAllProjects;
...
//  }
  ...
  private void initDialogSettings() {
    IDialogSettings ds = UIPlugin.getDefault().getDialogSettings();
