...
import org.modelica.mdt.ui.util.StringMatcher;
...
public class NamePatternFilter extends ViewerFilter {
	...
	public boolean select(Viewer viewer, Object parentElement, Object element) {
		...
		if (element instanceof IModelicaElement) {
			matchName= ((IModelicaElement) element).getElementName();
		} else if (element instanceof IAdaptable) {
			IAdaptable adaptable= (IAdaptable) element;
			IModelicaElement modelicaElement= (IModelicaElement)adaptable.getAdapter(IModelicaElement.class);
			if (modelicaElement != null)
				matchName= modelicaElement.getElementName();
			else {
