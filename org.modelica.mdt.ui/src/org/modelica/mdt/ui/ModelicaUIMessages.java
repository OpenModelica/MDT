...
public final class ModelicaUIMessages extends NLS {

	private static final String BUNDLE_NAME= "org.modelica.mdt.ui.ModelicaUIMessages";//$NON-NLS-1$

	private ModelicaUIMessages() {
		// Do not instantiate
	}
	...
	public static String ModelicaEditor_codeassist_noCompletions;
	...
	static {
		NLS.initializeMessages(BUNDLE_NAME, ModelicaUIMessages.class);
	}
