...
public class CompletionContext {
	 ...
	 * @since 3.2
	 */
	public boolean isInModelicadoc() {
	 ...
	 * <code>null</code> if there is no expected types.
	 *
	 * @see org.eclipse.jdt.core.dom.ASTParser#createASTs(IModelicaSourceFile[], String[], org.eclipse.jdt.core.dom.ASTRequestor, org.eclipse.core.runtime.IProgressMonitor)
	 */
	 ...
	 * @since 3.4
	 */
	public IModelicaElement getEnclosingElement() {
		return null; // default overridden by concrete implementation
	}
	 ...
	 * @since 3.4
	 */
	public IModelicaElement[] getVisibleElements(String typeSignature) {
		return null; // default overridden by concrete implementation
	}
