...
public class Strings {
	...
	public static StyledString markLTR(StyledString styledString) {
		...
		return markLTR(styledString, null);		
	}
	 ...
	 * @since 3.1
	 */
	public static int computeIndentUnits(String line, IModelicaProject project) {
		return 2;
	}
	 ...
	 * @since 3.1
	 */
	public static String trimIndent(String line, int indentsToRemove, IModelicaProject project) {
		return IndentManipulation.trimIndent(line, indentsToRemove, 2, 2);
	}
	 ...
	 * @since 3.1
	 */
	public static void trimIndentation(String[] lines, IModelicaProject project) {
		trimIndentation(lines, 2, 2, true);
	}
	/**
	 * Removes the common number of indents from all lines. If a line
	 * only consists out of white space it is ignored.
	 ...
	 * @since 3.1
	 */
	public static void trimIndentation(String[] lines, IModelicaProject project, boolean considerFirstLine) {
		trimIndentation(lines, 2, 2, considerFirstLine);
	}
	 ...
	 * @since 3.1
	 */
	public static String getIndentString(String line, IModelicaProject project) {
		return IndentManipulation.extractIndentString(line, 2, 2);
	}
	 ...
	 * @since 3.1
	 */
	public static String changeIndent(String code, int codeIndentLevel, IModelicaProject project, String newIndent, String lineDelim) {
		return IndentManipulation.changeIndent(code, codeIndentLevel, 2, 2, newIndent, lineDelim);
	}
	...
	public static String trimIndentation(String source, IModelicaProject project, boolean considerFirstLine) {
		return trimIndentation(source, 2, 2, considerFirstLine);
	}
