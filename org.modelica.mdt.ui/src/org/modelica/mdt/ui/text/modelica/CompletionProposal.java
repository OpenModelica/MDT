...
public class CompletionProposal {
	...
	public static CompletionProposal create(int kind, int completionOffset) {
		return new ModelicaCompletionProposal(kind, completionOffset);
	}
	 ...
	 * @see org.eclipse.jdt.core.dom.ASTParser#createASTs(IModelicaSourceFile[], String[], org.eclipse.jdt.core.dom.ASTRequestor, IProgressMonitor)
     * @since 3.1
	 */
