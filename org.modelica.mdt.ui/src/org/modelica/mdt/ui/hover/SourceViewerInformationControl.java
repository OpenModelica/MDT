...
import org.modelica.mdt.ui.editor.ModelicaSourceViewer;
...
public class SourceViewerInformationControl implements IInformationControl, IInformationControlExtension, DisposeListener {
	...
	public SourceViewerInformationControl(Shell parent, int shellStyle, int style, String statusFieldText) {
		...
		// Source viewer
		fViewer= new ModelicaSourceViewer(composite, null, null, false, style);
		fViewer.configure(new SimpleModelicaSourceViewerConfig(null, IModelicaPartitions.MODELICA_PARTITIONING));
	...
	/**
	 * Initialize the font to the Modelica editor font.
	 * 
	 * @since 3.2
	 */
	...
	public void setInformation(String content) {
		...
		UIPlugin.getDefault().getModelicaTextTools().setupModelicaDocumentPartitioner(doc, IModelicaPartitions.MODELICA_PARTITIONING);
