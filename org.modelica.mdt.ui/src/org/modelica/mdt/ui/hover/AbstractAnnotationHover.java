...
import org.modelica.mdt.ui.editor.JavaAnnotationIterator;
 ...
 * @since 3.0
 */
public abstract class AbstractAnnotationHover extends AbstractModelicaEditorTextHover {
	...
	private final IPreferenceStore fStore= null; 
	...
	public Object getHoverInfo2(ITextViewer textViewer, IRegion hoverRegion) {
		...
		try {
			...
			try {
				...
				ErrorManager.logError(ex.getStatus());
			}
		}
