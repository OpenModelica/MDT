...
import org.modelica.uml.sysml.diagram.edit.policies.ModelicaProperty2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ModelicaProperty2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ModelicaProperty2EditPart(View view) {
		super(view);
	}
	...
	protected void refreshVisibility() {
		...
		if (model instanceof View) {
			...
			if (!parameter.getPropertyKind().equals(PropertyKind.PART_LITERAL)) {
				setVisibility(false);
			} else {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ModelicaProperty2ItemSemanticEditPolicy());
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return SysmlElementTypes.ModelicaProperty_2002;
					}
