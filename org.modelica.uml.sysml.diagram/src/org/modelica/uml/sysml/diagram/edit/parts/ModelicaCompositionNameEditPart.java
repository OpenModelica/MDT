 ...
 * @generated
 */
public class ModelicaCompositionNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(SysmlVisualIDRegistry
				.getType(ModelicaCompositionNameEditPart.VISUAL_ID), new Point(
				0, 40));
	}
	 ...
	 * @generated
	 */
	public ModelicaCompositionNameEditPart(View view) {
		super(view);
	}
	...
	protected String getLabelText() {
		...
		text = ModelicaPropertyUtil.getSignatureString(text,
				(ModelicaComposition) node.getElement());
		return text;
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return SysmlElementTypes.ModelicaComposition_3002;
					}
	 ...
	 * @generated
	 */
	public class LabelFigure extends
	 ...
	 * @generated
	 */
	public static final org.eclipse.swt.graphics.Font LABELFIGURE_FONT = new org.eclipse.swt.graphics.Font(
