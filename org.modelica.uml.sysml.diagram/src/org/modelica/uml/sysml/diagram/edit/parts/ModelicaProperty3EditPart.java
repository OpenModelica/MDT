...
import org.modelica.uml.sysml.diagram.edit.policies.ModelicaProperty3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ModelicaProperty3EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ModelicaProperty3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ModelicaProperty3ItemSemanticEditPolicy());
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return SysmlElementTypes.ModelicaProperty_2003;
					}
