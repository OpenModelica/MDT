...
import org.modelica.uml.sysml.diagram.edit.policies.ModelicaPropertyCanonicalEditPolicy;
import org.modelica.uml.sysml.diagram.edit.policies.ModelicaPropertyGraphicalNodeEditPolicy;
...
import org.modelica.uml.sysml.diagram.edit.policies.ModelicaPropertyItemSemanticEditPolicy;
import org.modelica.uml.sysml.diagram.part.SysmlVisualIDRegistry;

import org.modelica.uml.sysml.diagram.edit.policies.SysmlTextNonResizableEditPolicy;
...
import org.modelica.uml.sysml.diagram.edit.util.ModelicaPropertyUtil;

/**
 * @generated
 */
public class ModelicaPropertyEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ModelicaPropertyEditPart(View view) {
		super(view);
	}
	...
	protected void refreshVisibility() {
		...
		if (model instanceof View) {
			...
			ModelicaProperty parameter = (ModelicaProperty) view.getElement();
			if (!parameter.getPropertyKind().equals(
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ModelicaPropertyItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new SysmlTextNonResizableEditPolicy());
	...
	protected String getLabelText() {
		...
		text = ModelicaPropertyUtil.getSignatureStringWithDefault(text,
				(ModelicaProperty) node.getElement());
		return text;
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return SysmlElementTypes.ModelicaProperty_2001;
					}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), SysmlEditPartFactory
