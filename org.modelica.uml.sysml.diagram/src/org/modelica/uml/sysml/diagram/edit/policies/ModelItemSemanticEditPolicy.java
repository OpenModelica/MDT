...
public class ModelItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if (SysmlElementTypes.Enumeration_1002 == req.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(UMLPackage.eINSTANCE
						.getPackage_PackagedElement());
			}
			return getMSLWrapper(new CreateEnumeration_1002Command(req));
		}
	 ...
	 * @generated
	 */
	private static class CreateEnumeration_1002Command extends
			CreateElementCommand {

		/**
		 * @generated
		 */
		public CreateEnumeration_1002Command(CreateElementRequest req) {
			super(req);
		}
