package org.modelica.uml.sysml.diagram.expressions;
...
public abstract class SysmlAbstractExpression {
	...
	private static final boolean DISABLED_NO_IMPL_EXCEPTION_LOG = Boolean
			.valueOf(
					Platform.getDebugOption(SysmlDiagramEditorPlugin
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = SysmlDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	public static final SysmlAbstractExpression createNullExpression(
			EClassifier context) {
		return new SysmlAbstractExpression(context) {
